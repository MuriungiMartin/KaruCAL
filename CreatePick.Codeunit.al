...
Codeunit 7312 "Create Pick"
{
          ...
          if not Location."Directed Put-away and Pick" then begin
            ...
            if QtyAvailableBase > 0 then begin
              ...
              CalcBWPickBin(
                ...
                QtyPerUnitofMeasure,TotalQtytoPick,TotalQtytoPickBase,TempWhseItemTrackingLine,Location."Use Cross-Docking");
            end;
            exit;
          end;
    ...
    local procedure CalcBWPickBin(LocationCode: Code[10];ItemNo: Code[20];VariantCode: Code[10];UnitofMeasureCode: Code[10];QtyPerUnitofMeasure: Decimal;var TotalQtyToPick: Decimal;var TotalQtytoPickBase: Decimal;var TempWhseItemTrackingLine: Record "Whse. Item Tracking Line" temporary;CrossDockFirst: Boolean)
    var
        WhseSource2: Option;
    begin
        // Basic warehousing
          ...
          case WhseSource2 of
            Whsesource::"Pick Worksheet":
              FindBWPickBin(
                ...
                TotalQtyToPick,TotalQtytoPickBase,TempWhseItemTrackingLine,false);
            Whsesource::Shipment:
              FindBWPickBin(
                LocationCode,ItemNo,VariantCode,
          ...
          case WhseSource2 of
            ...
            Whsesource::Shipment:
              FindBWPickBin(
                ...
                TotalQtyToPick,TotalQtytoPickBase,TempWhseItemTrackingLine,CrossDockFirst);
            Whsesource::Production:
              FindBWPickBin(
                LocationCode,ItemNo,VariantCode,
    ...
    local procedure FindBWPickBin(LocationCode: Code[10];ItemNo: Code[20];VariantCode: Code[10];ToBinCode: Code[20];UnitofMeasureCode: Code[10];QtyPerUnitofMeasure: Decimal;DefaultBin: Boolean;var TotalQtyToPick: Decimal;var TotalQtyToPickBase: Decimal;var TempWhseItemTrackingLine: Record "Whse. Item Tracking Line" temporary;CrossDockFirst: Boolean)
    var
        FromBinContent: Record "Bin Content";
        QtyAvailableBase: Decimal;
        QtyToPickBase: Decimal;
    ...
    begin
        ...
        if not HasExpiredItems then begin
          ...
          CannotBeHandledMessage := ItemTrackingDataCollection.GetResultMessageForExpiredItem;
        end;
    end;
    ...
    procedure CheckReservation(QtyBaseAvailToPick: Decimal;LocationCode: Code[10];SourceType: Integer;SourceSubType: Option;SourceNo: Code[20];SourceLineNo: Integer;SourceSubLineNo: Integer;QtyPerUnitOfMeasure: Decimal;var Quantity: Decimal;var QuantityBase: Decimal)
    var
    ...
    procedure CalcTotalAvailQtyToPick(LocationCode: Code[10];ItemNo: Code[20];VariantCode: Code[10];LotNo: Code[20];SerialNo: Code[20];SourceType: Integer;SourceSubType: Option;SourceNo: Code[20];SourceLineNo: Integer;SourceSubLineNo: Integer;NeededQtyBase: Decimal;RespectLocationBins: Boolean): Decimal
    var
    ...
    procedure CalcReservedQtyOnInventory(ItemNo: Code[20];LocationCode: Code[10];VariantCode: Code[10];LotNo: Code[20];LNRequired: Boolean;SerialNo: Code[20];SNRequired: Boolean) ReservedQty: Decimal
    var
    ...
    local procedure InsertTempBinContentBuf(var TempBinContentBuffer: Record "Bin Content Buffer" temporary;LocationCode: Code[10];BinCode: Code[20];ItemNo: Code[20];VariantCode: Code[10];UnitOfMeasureCode: Code[10];LotNo: Code[20];SerialNo: Code[20];QtyBase: Decimal)
    begin
