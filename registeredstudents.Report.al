...
Report 51875 registeredstudents
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/registeredstudents.rdlc';

    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            RequestFilterFields = Semester,"Stoppage Reason";
            ...
            column(StoppageReason;"ACA-Course Registration"."Stoppage Reason")
            {
            }
            column(StudentNo;"ACA-Course Registration"."Student No.")
            {
            }
    ...
    begin
        ...
        // "ACA-Course Registration".SETFILTER("ACA-Course Registration".Semester,'%1',Semesters)
    end;
    ...
    var
        ...
        Text024: label '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------';
        stopreason: Record UnknownRecord66620;
}
