...
Page 6711 "OData Setup Wizard"
{
    ...
    begin
        ...
        if "Object Type" = "object type"::Query then begin
          ...
          ODataUrl := ODataUtility.GenerateUrl(ODataServiceRootUrl,TenantWebService."Service Name",Objecttypeparam::Query);
          exit(ODataUrl);
        end;
        if "Object Type" = "object type"::Page then begin
          ...
          ODataUrl := ODataUtility.GenerateUrl(ODataServiceRootUrl,TenantWebService."Service Name",Objecttypeparam::Page);
          exit(ODataUrl);
        end;
    end;
    ...
    begin
        ...
        then begin
          ...
          ODataUtility.GenerateFilterText(ServiceNameEdit,ObjectTypeLookup,FilterText);
          TenantWebServiceOData.SetOdataSelectClause(SelectText);
          TenantWebServiceOData.SetOdataFilterClause(FilterText);
          TenantWebServiceOData.Insert(true)
        end else begin
          TenantWebServiceOData.Validate(TenantWebServiceID,TenantWebService.RecordId);
          ODataUtility.GenerateSelectText(ServiceNameLookup,ObjectTypeLookup,SelectText);
          ODataUtility.GenerateFilterText(ServiceNameLookup,ObjectTypeLookup,FilterText);
          TenantWebServiceOData.SetOdataSelectClause(SelectText);
          TenantWebServiceOData.SetOdataFilterClause(FilterText);
