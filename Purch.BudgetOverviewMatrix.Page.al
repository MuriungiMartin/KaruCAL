        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(Quantity;+Quantity)
                {
                    ...
                    Editable = false;
                    StyleExpr = 'Strong';
                    ToolTip = 'Specifies the total quantity of the purchase budget entries for the item.';
                ...
                field(Amount;+Amount)
                {
                    ...
                    StyleExpr = 'Strong';
                    ToolTip = 'Specifies the total cost of the purchase budget entries for the item.';
