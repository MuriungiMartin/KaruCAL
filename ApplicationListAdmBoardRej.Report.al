...
Report 51358 "Application List Adm Board Rej"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Adm Board Rej.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const("Admission Board Rejected"));
