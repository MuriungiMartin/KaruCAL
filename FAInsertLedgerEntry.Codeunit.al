...
Codeunit 5600 "FA Insert Ledger Entry"
{
    ...
    procedure InsertReverseEntry(NewGLEntryNo: Integer;FAEntryType: Option " ","Fixed Asset",Maintenance;FAEntryNo: Integer;var NewFAEntryNo: Integer;TransactionNo: Integer;var ReversalEntry: Record "Reversal Entry")
    var
    ...
    local procedure SetFAReversalMark(var ReversalEntry: Record "Reversal Entry";var FALedgEntry: Record "FA Ledger Entry";NextEntryNo: Integer)
    var
        FALedgEntry2: Record "FA Ledger Entry";
    ...
    local procedure SetMaintReversalMark(var ReversalEntry: Record "Reversal Entry";var MaintenanceLedgEntry: Record "Maintenance Ledger Entry";NextEntryNo: Integer)
    var
