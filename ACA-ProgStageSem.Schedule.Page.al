...
Page 66034 "ACA-Prog/Stage Sem. Schedule"
{
    PageType = List;
    SourceTable = UnknownTable66034;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Scheduled Stages Units";"Scheduled Stages Units")
                {
                    ApplicationArea = Basic;
                }
        ...
        area(creation)
        {
            action(UpdateSchedules)
            {
                ...
                begin
                    ...
                    if Rec."Stage Code" = '' then Error('No Stage Specified');
                    if Confirm('Update Units Schedules?',false)=false then Error('Cancelled!');
                    ...
                    ACAProgStageUnitSemSche.SetRange("Stage Code",Rec."Stage Code");
                    ...
                    ACALectureMarksPermissions.SetRange("Stage Code",Rec."Stage Code");
                    ...
                    ACAProgrammeStages.SetRange(Code,Rec."Stage Code");
                    ...
                    // ACAProgStageSemSchedule."Start Date":=Rec.From;
                    // ACAProgStageSemSchedule."End Date":=Rec."To";
