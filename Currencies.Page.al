    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the general ledger account to post exchange rate gains to for currency adjustments between $ and the additional reporting currency.';
                    Visible = false;
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the general ledger account to post residual amount gains to, if you post in the general ledger application area in both $ and an additional reporting currency.';
                    Visible = false;
                }
                field("Residual Losses Account";"Residual Losses Account")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the general ledger account to post residual amount losses to, if you post in the general ledger application area in both $ and an additional reporting currency.';
                    Visible = false;
                }
                ...
                {
                    ApplicationArea = Suite;
                    ToolTip = 'Specifies conversion information that must also contain a debit account if you wish to insert correction lines for rounding differences in the general journals using the Insert Conv. $ Rndg. Lines function.';
                }
                field("Conv. LCY Rndg. Credit Acc.";"Conv. LCY Rndg. Credit Acc.")
                {
                    ApplicationArea = Suite;
                    ToolTip = 'Specifies conversion information that must also contain a credit account if you wish to insert correction lines for rounding differences in the general journals using the Insert Conv. $ Rndg. Lines function.';
                }
                field("Max. VAT Difference Allowed";"Max. VAT Difference Allowed")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the maximum tax correction amount allowed for the currency.';
                    Visible = false;
                }
                field("VAT Rounding Type";"VAT Rounding Type")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies how the program will round tax when calculated for this currency.';
                    Visible = false;
                }
                ...
                field(CurrencyFactor;CurrencyFactor)
                {
                    ...
                    DecimalPlaces = 1:6;
                    ToolTip = 'Specifies the relationship between the additional reporting currency and the local currency. Amounts are recorded in both $ and the additional reporting currency, using the relevant exchange rate and the currency factor.';
    ...
    actions
    {
        ...
        area(reporting)
        {
            action("Foreign Currency Balance")
            {
                ...
                ToolTip = 'View the balances for all customers and vendors in both foreign currencies and in local currency ($). The report displays two $ balances. One is the foreign currency balance converted to $ by using the exchange rate at the time of the transaction. The other is the foreign currency balance converted to $ by using the exchange rate of the work date.';
            }
        }
        area(navigation)
        {
