...
Codeunit 1655 "Office Add-In Sample Emails"
{
    ...
    var
        ...
        SalesQuoteInst2Txt: label 'On the lines of the quote, enter the items that Coho Winery wants and how many of each.';
    ...
    begin
        HTMLBody := '<html>' +
          ...
          '  </v:shape><![endif]--><![if !vml]><img width=188 height=50' +
