...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales Order.rdlc';
    Caption = 'Sales Order';
        ...
        dataitem("Sales Header";"Sales Header")
        {
            ...
            dataitem("Sales Line";"Sales Line")
            {
                ...
                dataitem(SalesLineComments;"Sales Comment Line")
                {
                    ...
                    DataItemTableView = sorting("Document Type","No.","Document Line No.","Line No.") where("Document Type"=const(Order),"Print On Order Confirmation"=const(Yes));
            ...
            dataitem("Sales Comment Line";"Sales Comment Line")
            {
                ...
                DataItemTableView = sorting("Document Type","No.","Document Line No.","Line No.") where("Document Type"=const(Order),"Print On Order Confirmation"=const(Yes),"Document Line No."=const(0));
