...
Report 51615 "KCA Inst Rcpt items Date"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/KCA Inst Rcpt items Date.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61539;UnknownTable61539)
        {
            ...
            begin
                if Rcpt.Get("ACA-Receipt Items"."Receipt No") = false then begin
                //"Receipt Items"."Student No.":=Rcpt."Student No.";
                //"Receipt Items".Date:=Rcpt.Date;
