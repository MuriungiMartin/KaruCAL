...
Report 99957 "Exam Entry Statistics"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exam Entry Statistics.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable65201;UnknownTable65201)
        {
            ...
            dataitem(UnknownTable65202;UnknownTable65202)
            {
                ...
                {
                    DataItemLink = Semester=field(Semester),Programme=field(Programme),Stage=field(Stage),Unit=field(Unit);
                    column(ReportForNavId_1000000063; 1000000063)
                    {
                    }
                    column(SPrograme;"ACA-Student Units".Programme)
                    {
                    }
                    column(SStage;"ACA-Student Units".Stage)
                    {
                    }
                    column(SSemester;"ACA-Student Units".Semester)
                    {
                    }
                    column(SUnit;"ACA-Student Units".Unit)
                    {
                    }
