...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Vendor 1099 Div.rdlc';
    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            column(GetAmtCombinedDivCodeAB;GetAmt('DIV-01-A') + GetAmt('DIV-01-B') + GetAmt('DIV-05'))
            {
            }
            ...
            column(GetAmtDIV08;GetAmt('DIV-08'))
            {
            }
    ...
    var
        ...
        FormBox: Record UnknownRecord10010;
