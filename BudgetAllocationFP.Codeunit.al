...
Codeunit 50108 "Budget Allocation FP"
{
    ...
    procedure AutoAllocatePurch(var Rec: Record UnknownRecord61698)
    var
    ...
    begin
        ...
        NewDate:="Start Date";
        /*Get the period*/
        if "Period Type"="period type"::Daily then
          begin
            Period:='D';
          end
        else if "Period Type"="period type"::Weekly then
          begin
            Period:='W';
          end
        else if "Period Type"="period type"::Monthly then
          begin
            Period:='M';
          end
        else if "Period Type"="period type"::Quarterly then
          begin
            Period:='Q';
          end
        else
        ...
        */
            ...
            if "Show As"="show as"::Quantity then
              begin
                GLBudgetEntry."Sales Amount":=Amnt;
              end
            else if "Show As"="show as"::"Cost Amount" then
              begin
    ...
    procedure AutoAllocateSale(var Rec: Record UnknownRecord61700)
    var
        Budget: Record "Item Budget Name";
        DimVal: Record "Dimension Value";
        GLBudgetEntry: Record "Item Budget Entry";
    ...
    begin
        ...
        */
            ...
            if "Show As"="show as"::"Sales Amount" then
              begin
                GLBudgetEntry."Sales Amount":=Amnt;
              end
            else if "Show As"="show as"::Quantity then
              begin
                GLBudgetEntry.Quantity:=Amnt;
              end
            else if "Show As"="show as"::COGS then
              begin
                GLBudgetEntry."Cost Amount":=Amnt;
              end;
    ...
    procedure AutoAllocateGL(var Rec: Record UnknownRecord61699)
    var
    ...
    begin
        ...
        if "Type of Entry"="type of entry"::" " then
          begin
          ...
          do
           ...
           /*
            ...
            GLBudgetEntry.VALIDATE(GLBudgetEntry."Budget Dimension 6 Code");
                              */
            GLBudgetEntry.Date:=NewDate;
            if "Type of Entry"="type of entry"::Debit then
              begin
                GLBudgetEntry.Amount:=Amnt;
              end
            else if "Type of Entry"="type of entry"::Credit then
              begin
                GLBudgetEntry.Amount:=-Amnt;
              end;
            GLBudgetEntry."User ID":=UserId;
