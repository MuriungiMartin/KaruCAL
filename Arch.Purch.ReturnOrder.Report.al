...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Arch.Purch. Return Order.rdlc';
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Purchase Line Archive";"Purchase Line Archive")
                    {
                        ...
                        column(ReportForNavId_6370; 6370)
                        {
                        }
    ...
    var
        ...
        VATAmountLine__VAT_Base__Control99CaptionLbl: label 'Tax Base';
        VATAmountLine__VAT_Amount__Control100CaptionLbl: label 'Tax Amount';
        ...
        VALVATAmountLCY_Control158CaptionLbl: label 'Tax Amount';
        VALVATBaseLCY_Control159CaptionLbl: label 'Tax Base';
        VATAmountLine__VAT____Control160CaptionLbl: label 'Tax %';
        VATAmountLine__VAT_Identifier__Control161CaptionLbl: label 'Tax Identifier';
        ...
        PrepmtVATAmountLine__VAT_Amount__Control194CaptionLbl: label 'Tax Amount';
        PrepmtVATAmountLine__VAT_Base__Control195CaptionLbl: label 'Tax Base';
        PrepmtVATAmountLine__Line_Amount__Control196CaptionLbl: label 'Line Amount';
        PrepmtVATAmountLine__VAT____Control197CaptionLbl: label 'Tax %';
        Prepayment_VAT_Amount_SpecificationCaptionLbl: label 'Prepayment Tax Amount Specification';
        PrepmtVATAmountLine__VAT_Identifier_CaptionLbl: label 'Tax Identifier';
