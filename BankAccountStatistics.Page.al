        ...
        area(content)
        {
            group(Balance)
            {
                ...
                field("Balance (LCY)";"Balance (LCY)")
                {
                    ...
                    AutoFormatType = 1;
                    Caption = 'Balance ($)';
                    ToolTip = 'Specifies the bank account''s current balance in $.';
                }
                ...
                fixed(Control1904230801)
                {
                    group("This Period")
                    {
                        ...
                        field("BankAccNetChange[1]";BankAccNetChange[1])
                        {
                            ...
                            AutoFormatType = 1;
                            Caption = 'Net Change';
                            ToolTip = 'Specifies the net value of entries in $ on the bank account for the periods: Current Month, This Year, Last Year and To Date.';
                        }
