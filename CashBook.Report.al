...
Report 51239 "Cash Book"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Cash Book.rdlc';
    ...
    dataset
    {
        dataitem("Bank Account";"Bank Account")
        {
            ...
            trigger OnPreDataItem()
            begin
                //"Bank Account".SETRANGE("Bank Account"."No.",'KCB/C');
                ...
                CurrReport.CreateTotals("Bank Account Ledger Entry"."Credit Amount");
            end;
        }
    }
