...
Page 68000 "FIN-Bank Acc. Statem. Lines"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    procedure GetSelectedRecords(var TempBankAccReconciliationLine: Record UnknownRecord61000 temporary)
    var
        BankAccReconciliationLine: Record UnknownRecord61000;
    begin
