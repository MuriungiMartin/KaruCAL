...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Vendor Account Detail.rdlc';
    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            column(GetCurrencyCaptionCode__Currency_Code__;CaptionClassTranslate(GetCurrencyCaptionCode("Currency Code")))
            {
            }
            ...
            dataitem("Vendor Ledger Entry";"Vendor Ledger Entry")
            {
                ...
                column(PV;"Vendor Ledger Entry"."Applies-to Doc. No.")
                {
                }
                ...
                dataitem(OtherInfo;"Integer")
                {
                    ...
                    {
                        OptionMembers = ,Payment,Invoice,"Credit Memo","Finance Charge";
                    }
                ...
                trigger OnAfterGetRecord()
                begin
                    "Vendor Ledger Entry".CalcFields("Payment Ref");
            ...
            begin
                ...
                if FilterString2 = '' then begin
                  ...
                  VendLedgerEntry2.SetCurrentkey("Vendor No.");
