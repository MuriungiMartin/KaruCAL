...
Page 9297 "Inventory - G/L Recon Matrix"
{
    ...
    procedure Load(MatrixColumns1: array [32] of Text[1024];var MatrixRecords1: array [32] of Record "Dimension Code Buffer";CurrentNoOfMatrixColumns: Integer;ShowWarningLocal: Boolean;DateFilterLocal: Text[30];ItemFilterLocal: Code[250];LocationFilterLocal: Code[250])
    begin
