...
Page 77382 "Core_Banking Header List"
{
    ApplicationArea = Basic;
    CardPageID = Core_Banking_Header_Card;
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    PageType = List;
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Update Pesa flow")
            {
                ApplicationArea = Basic;
                Caption = 'Update Pesa flow';
                Image = UpdateXML;
                Promoted = true;
                PromotedIsBig = true;
                PromotedOnly = true;
                RunObject = Report "Update Pesa Flow Transactions";
            }
        }
    }
}
