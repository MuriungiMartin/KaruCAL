            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ImportOption;ImportOption)
                    {
                        ...
                        ToolTip = 'Specifies if the budget entries are added from Excel to budget entries that are currently in the system or are replaced in Dynamics NAV with the budget entries from Excel.';
                    }
