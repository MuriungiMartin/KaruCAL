                ...
                group(Options)
                {
                    ...
                    group(Apply)
                    {
                        ...
                        field(DateAdjustExpression;DateAdjustExpression)
                        {
                            ...
                            ToolTip = 'Specifies how the dates on the entries that are copied are changed. Use a date formula; for example, to copy last week''s budget to this week, use the formula 1W (one week).';
                        }
