        ...
        area(content)
        {
            repeater(Control1)
            {
                field("Job No.";"Job No.")
                {
                    ...
                    ToolTip = 'Specifies the number of the job to which this resource price applies.';
                }
                ...
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the sales price that applies to this line. This price is in the currency represented by the code in the Currency Code field on this line.';
                }
