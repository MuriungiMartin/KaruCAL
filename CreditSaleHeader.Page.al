...
Page 65010 "Credit Sale Header"
{
    ...
    begin
        ...
        "Posting Description":='Credit Sale '+FINCashOfficeUserTemplate.User_ID+','+FINCashOfficeUserTemplate."Default Direct Sales Location"+','+FINCashOfficeUserTemplate."Direct Sales Item Category";
        "Due Date":=Today;
    ...
    var
        ...
        DirectCreditSalesBuffDet: Record UnknownRecord65010;
    ...
    begin
        ...
        //"Bal. Account Type":="Bal. Account Type"::"Bank Account";
        //"Bal. Account No.":=FINCashOfficeUserTemplate."Direct Cash Sale Bank";
        "Posting Description":=CopyStr('Credit Sale '+FINCashOfficeUserTemplate.User_ID+','+FINCashOfficeUserTemplate."Default Direct Sales Location"+','+FINCashOfficeUserTemplate."Direct Sales Item Category",1,50);
        "Due Date":=Today;
        if DirectCreditSalesBuffDet."Location Code"<>'' then
        "Location Code":=DirectCreditSalesBuffDet."Location Code"
        else
