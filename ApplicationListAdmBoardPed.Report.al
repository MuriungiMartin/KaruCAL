...
Report 51378 "Application List Adm Board Ped"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Adm Board Ped.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const(Approved));
