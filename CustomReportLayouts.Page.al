        ...
        area(content)
        {
            repeater(Group)
            {
                field("Code";Code)
                {
                    ...
                    ToolTip = 'Specifies the Code. This field is intended only for internal use.';
                    Visible = false;
                }
                ...
                field("Report Name";"Report Name")
                {
                    ApplicationArea = Basic,Suite;
                    Enabled = false;
                    ToolTip = 'Specifies the name of the report that the report layout applies to.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the Microsoft Dynamics NAV user who made the last change to the report layout entry.';
                    Visible = false;
                }
            }
        }
