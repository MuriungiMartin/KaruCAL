...
Codeunit 432 Consolidate
{
    ...
    local procedure CreateAndPostGenJnlLine(GenJnlLine: Record "Gen. Journal Line";var GLEntry: Record "G/L Entry";var DimBuf: Record "Dimension Buffer";PostDebit: Boolean)
    var
        TempDimSetEntry2: Record "Dimension Set Entry" temporary;
        DimValue: Record "Dimension Value";
    ...
    local procedure InitializeGLAccount(var PostDebit: Boolean)
    begin
        TestGLAccounts;
