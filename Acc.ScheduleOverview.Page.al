...
Page 490 "Acc. Schedule Overview"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field(UseAmtsInAddCurr;UseAmtsInAddCurr)
                {
                    ...
                    MultiLine = true;
                    ToolTip = 'Specifies that the Account Schedule Overview window shows amounts in the additional reporting currency.';
    ...
    local procedure GetDimValueTotaling(var DimValueFilter: Text;DimensionCode: Code[20])
    var
