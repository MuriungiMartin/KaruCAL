    ...
    layout
    {
        area(content)
        {
            repeater(Control1102601000)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies that the web service is published. A published web service is available on the Dynamics NAV Server computer that you were connected to when you published. The web service is available across all Dynamics NAV Server instances running on the server computer.';
                }
