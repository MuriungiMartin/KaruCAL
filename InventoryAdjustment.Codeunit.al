...
Codeunit 5895 "Inventory Adjustment"
{
    ...
    local procedure MakeSingleLevelAdjmt(var TheItem: Record Item)
    var
    ...
    local procedure AdjustAppliedOutbndEntries(OutbndItemLedgEntryNo: Integer;Recursion: Boolean;var TempAvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point" temporary;var InboundCompletelyInvoiced: Boolean): Boolean
    var
    ...
    local procedure CreateCostAdjmtBuf(OutbndValueEntry: Record "Value Entry";CostElementBuf: Record "Cost Element Buffer";ItemLedgEntryPostingDate: Date;EntryType: Option;var TempAvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point" temporary): Boolean
    begin
    ...
    local procedure CreateIndirectCostAdjmt(var CostElementBuf: Record "Cost Element Buffer";var AdjustedCostElementBuf: Record "Cost Element Buffer";OutbndValueEntry: Record "Value Entry";EntryType: Option;var TempAvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point" temporary)
    var
    ...
    local procedure AdjustItemAvgCost(var TempAvgCostAdjmtEntryPointToUpd: Record "Avg. Cost Adjmt. Entry Point" temporary)
    var
    ...
    local procedure UpdateAvgCostAdjmtEntryPoint(ValueEntry: Record "Value Entry";var TempAvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point" temporary)
    var
        AvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point";
    begin
        AvgCostAdjmtEntryPoint.UpdateValuationDate(ValueEntry);
    ...
    local procedure MakeWIPAdjmt(var SourceInvtAdjmtEntryOrder: Record "Inventory Adjmt. Entry (Order)")
    var
    ...
    local procedure PostOutputAdjmtBuf()
    begin
    ...
    local procedure PostOutput(InvtAdjmtBuf: Record "Inventory Adjustment Buffer")
    var
        ItemJnlLine: Record "Item Journal Line";
    ...
    local procedure MakeAssemblyAdjmt(var SourceInvtAdjmtEntryOrder: Record "Inventory Adjmt. Entry (Order)")
    var
        InvtAdjmtEntryOrder: Record "Inventory Adjmt. Entry (Order)";
        CalcInventoryAdjmtOrder: Codeunit "Calc. Inventory Adjmt. - Order";
        DoNotSkipItems: Boolean;
    ...
    local procedure UpdateAdjmtBuf(OrigValueEntry: Record "Value Entry";NewAdjustedCost: Decimal;NewAdjustedCostACY: Decimal;ItemLedgEntryPostingDate: Date;EntryType: Option;var TempAvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point" temporary): Boolean
    var
        ItemLedgEntry: Record "Item Ledger Entry";
        ItemApplnEntry: Record "Item Application Entry";
    ...
    local procedure AdjustNotInvdRevaluation(TransItemLedgEntry: Record "Item Ledger Entry";TransItemApplnEntry: Record "Item Application Entry";var TempAvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point" temporary)
    var
        TransValueEntry: Record "Value Entry";
        OrigItemLedgEntry: Record "Item Ledger Entry";
    ...
    local procedure CopyAdjmtEntryPointToBuf(var AvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point";var TempAvgCostAdjmtEntryPoint: Record "Avg. Cost Adjmt. Entry Point" temporary)
    begin
        with AvgCostAdjmtEntryPoint do
          if FindSet then
            repeat
