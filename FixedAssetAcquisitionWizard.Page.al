        ...
        area(content)
        {
            ...
            group(Step2)
            {
                ...
                group("Para2.1")
                {
                    ...
                    {
                        ApplicationArea = FixedAssets;
                        Caption = 'Acquisition Cost Incl. Tax';
                ...
                group("Para3.1")
                {
                    ...
                    group(Control27)
                    {
                        ...
                        field(ExternalDocNo;"External Document No.")
                        {
                            ...
                            ToolTip = 'Specifies the number that the vendor uses in their own system to refer to the document on which the fixed asset was sold.';
            ...
            group(Step4)
            {
                ...
                group("Para4.2")
                {
                    ...
                    field(OpenFAGLJournal;OpenFAGLJournal)
                    {
                        ...
                        ToolTip = 'Specifies that when you choose Finish, the Fixed Asset G/L Journal window opens showing the resulting journal lines, which you can edit and post manually.';
                    }
                }
            }
            group(StepInJournal)
