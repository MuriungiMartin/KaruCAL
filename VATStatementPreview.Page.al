        ...
        area(content)
        {
            group(General)
            {
                ...
                field(Selection;Selection)
                {
                    ...
                    ToolTip = 'Specifies that tax entries are included in the VAT Statement Preview window. This only works for lines of type Tax Entry Totaling. It does not work for lines of type Account Totaling.';
