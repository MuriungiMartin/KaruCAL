...
Report 99252 "13thSlip-Individual Payslips"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/13thSlip-Individual Payslips.rdlc';
                ...
                if PeriodTrans.Find('-') then
                    repeat
                         ...
                         begin
                            ...
                            if ((PeriodTrans."Group Text"='TOTAL DEDUCTIONS') or (PeriodTrans."Group Text"='TOTAL DEDUCTION'))  then
                            begin
                              Index:=Index+1;
                              Trans[ColumnNo,Index]:='...........................';
                              TransAmt[ColumnNo,Index]:='..........................';
