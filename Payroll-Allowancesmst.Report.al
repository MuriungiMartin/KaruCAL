...
Report 51737 "Payroll - Allowances mst"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Payroll - Allowances mst.rdlc';
    ...
    dataset
    {
        ...
        dataitem(UnknownTable61118;UnknownTable61118)
        {
            ...
            column(KENYA_WATER_INSITUTE_;'KARATINA UNIVERSITY OF SCIENCE & TECHNOLOGY')
            {
            }
