...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Purchase Prepmt. Doc. - Test.rdlc';
        ...
        dataitem("Purchase Header";"Purchase Header")
        {
            ...
            dataitem(PageCounter;"Integer")
            {
                ...
                dataitem(CopyLoop;"Integer")
                {
                    ...
                    {
                        DataItemTableView = sorting(Number) where(Number=filter(1..));
                        column(ReportForNavId_4883; 4883)
                        {
                        }
    ...
    var
        ...
        Text003: label 'Total %1 Incl. Tax';
        Text004: label 'Total %1 Excl. Tax';
        ...
        VATAmountLine__VAT_Amount__Control128CaptionLbl: label 'Tax Amount';
        VATAmountLine__VAT_Base__Control129CaptionLbl: label 'Tax Base';
