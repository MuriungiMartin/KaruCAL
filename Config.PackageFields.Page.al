        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Relation Table ID";"Relation Table ID")
                {
                    ApplicationArea = Basic,Suite;
                    BlankZero = true;
                    ToolTip = 'Specifies the ID for the table that contains a field that is related to the one in the migration table. For example, the ZIP code table has a relationship with the City field in the Company Information migration table.';
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies whether you can create additional values in the database during the configuration migration process. Select the check box to indicate that additional codes can be added to that field in Microsoft Dynamics NAV during the import of data from Excel.';
                }
        ...
        area(processing)
        {
            group("Fiel&ds")
            {
                ...
                action(Mapping)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'View the mapping of values from an existing ERP system into the Dynamics NAV implementation during the migration of data.';
