...
Page 5935 "Service Credit Memo"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Application)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies if you want to apply an invoice or a credit memo to a service document that is posted.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the applies-to ID of the posted entries, to which the given service document will be applied, if you use the Apply Entries function.';
                }
            }
        }
        area(factboxes)
    ...
    var
        ...
        OpenPostedServiceCrMemoQst: label 'The credit memo has been posted and moved to the Posted Service Credit Memos window.\\Do you want to open the posted credit memo?';
