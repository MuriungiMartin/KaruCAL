...
Page 68150 "PROC-Store Req. Header (B)"
{
    PageType = Card;
                    ...
                    begin
                        ...
                        if not LinesExists then
                           ...
                           // TESTFIELD("Issuing Store");
                            ...
                            //ReqLine.TESTFIELD(ReqLine."Issuing Store");

                            if ReqLine.Find('-') then begin
                              //IF ReqLine."Issue UserID"<>USERID THEN ERROR ('You are not  allowed to  issue goods from this store Kindly contact system administrator');
                ...
                action(sendApproval)
                {
                    ...
                    begin
                        if not LinesExists then
                          ...
                          State:=State::Open;
                         if Status<>Status::"Pending Approval" then State:=State::Open;
