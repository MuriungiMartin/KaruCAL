        ...
        area(content)
        {
            ...
            group(Reporting)
            {
                ...
                field("Realized G/L Losses Account";"Realized G/L Losses Account")
                {
                    ApplicationArea = Suite;
                    Importance = Promoted;
                    ToolTip = 'Specifies the general ledger account to post exchange rate losses to, for currency adjustments between $ and the additional reporting currency.';
                }
                field("Residual Gains Account";"Residual Gains Account")
                {
                    ApplicationArea = Suite;
                    Importance = Promoted;
                    ToolTip = 'Specifies the general ledger account to post residual amounts to that are gains, if you post in the general ledger application area in both $ and an additional reporting currency.';
                }
