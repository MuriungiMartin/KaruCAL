...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Salesperson Commissions.rdlc';
    ...
    dataset
    {
        dataitem("Salesperson/Purchaser";"Salesperson/Purchaser")
        {
            ...
            dataitem("Cust. Ledger Entry";"Cust. Ledger Entry")
            {
                ...
                begin
                    CurrReport.CreateTotals("Sales (LCY)","Profit (LCY)",ProfitCommission,SalesCommission);
                end;
            }
            ...
            begin
                CurrReport.CreateTotals("Cust. Ledger Entry"."Sales (LCY)","Cust. Ledger Entry"."Profit (LCY)",
                  ProfitCommission,SalesCommission);
