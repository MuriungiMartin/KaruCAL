        ...
        area(processing)
        {
            ...
            group(AcadReportss)
            {
                ...
                group(AcadReports2)
                {
                    ...
                    {
                        ApplicationArea = Basic;
                        RunObject = Report "All Registered Students";
                    }
            ...
            group("Time Table Reports")
            {
                ...
                group(Buffering)
                {
                    ...
                    action(ResultsBufferSetups)
                    {
                        ApplicationArea = Basic;
                        Caption = 'Buffer Setups';
                        Image = ImportExcel;
                        Promoted = true;
                        RunObject = Page "ACA-Results Buffer Setup";
                    }
                    action(ResultsWorkflow)
                    {
                        ApplicationArea = Basic;
                        Caption = 'Results Workflow';
                        Image = UserSetup;
                        RunObject = Page "ACA-Results Workflow Templates";
                    }
                    action(ResultsApprovalRequests)
                    {
                        ApplicationArea = Basic;
                        Caption = 'Results Approval Requests';
                        Image = UpdateShipment;
                        Promoted = true;
                        PromotedIsBig = true;
                        PromotedOnly = true;
                        RunObject = Page "ACA-Res. Approval Entries List";
                    }
                    action(ApprovedApprovalResults)
                    {
                        ApplicationArea = Basic;
                        Caption = 'Approved Results Approval Requests';
                        Image = UserSetup;
                        RunObject = Page "ACA-My Approved for Post";
                    }
                    action("Update Student Photos")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Update Student Photos';
                        RunObject = Report "Upload Student Photos";
                    }
                }
            ...
            group(Setups1)
            {
                ...
                group(Setups)
                {
                    ...
                    action(UpdateResBuffer)
                    {
                        ApplicationArea = Basic;
                        Caption = 'Update Results Buffer';
                    ...
                    action("Rubrics (Med/Eng./Nursing)")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Rubrics (Med/Eng./Nursing)';
                        Image = StopPayment;
                        RunObject = Page "ACA-BMED Senate Rubrics";
                        Visible = false;
                    }
                    action("Missing Marks Report")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Missing Marks Report';
                        Image = Balance;
                        RunObject = Report "Missing Marks Report";
                    }
                    ...
                    action("Semester Stoppage Reasons")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Semester Stoppage Reasons';
                        Image = AmountByPeriod;
                        Promoted = true;
                        PromotedIsBig = true;
                        RunObject = Page "ACA-Stoppage Reasons";
                    }
                    action("Clear Options")
                    {
                        ...
                        Promoted = true;
                        PromotedIsBig = true;
                        RunObject = Report "Clear Prog. Options";
                    }
                }
            }
