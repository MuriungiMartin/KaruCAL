...
Codeunit 1032 "Job Planning Line-Reserve"
{
    ...
    procedure CreateReservation(JobPlanningLine: Record "Job Planning Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[20];ForLotNo: Code[20])
    var
        PlanningDate: Date;
        SignFactor: Integer;
    begin
    ...
    begin
        ...
        CreateReservationSetFrom(TrackingSpecification);
        CreateReservation(
          JobPlanningLine,ReqLine.Description,ReqLine."Due Date",ReservQty,ReservQtyBase,'','');
    end;
}
