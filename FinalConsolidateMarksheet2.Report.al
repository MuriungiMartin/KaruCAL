...
Report 78016 "Final Consolidate Marksheet 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Final Consolidate Marksheet 2.rdlc';
        ...
        dataitem(UnknownTable78007;UnknownTable78007)
        {
            ...
            dataitem(UnknownTable61532;UnknownTable61532)
            {
                ...
                dataitem(UnknownTable61549;UnknownTable61549)
                {
                    ...
                    DataItemTableView = where(Taken=filter(Yes),"Old Unit"=filter(No),"Reg. Reversed"=filter(No));
