...
Report 51547 "Time Table - By Year"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Time Table - By Year.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61514;UnknownTable61514)
        {
            ...
            begin
                ...
                T[Lessons."No."] :=T[Lessons."No."] + '[' + TimeTable.Programme + ' ' +  TimeTable.Exam
                 + ' ' + TimeTable.Unit + ' ' + TimeTable.Class + ' ' + Lec + ' ' +  TimeTable."Lecture Room" + '] ';

                end else if (TimeTable.Class = '') and (TimeTable.Exam = '') then begin
                if StrLen(T[Lessons."No."]) < 245 then
                T[Lessons."No."] :=T[Lessons."No."] + '[' + TimeTable.Programme + ','
