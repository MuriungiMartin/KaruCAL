...
Page 1661 "Payroll Import Transactions"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Control2)
            {
                InstructionalText = 'Map the External Account to G/L Accounts.';
    ...
    var
        ...
        NAVNotSetUpQst: label 'The Payroll Transactions have not been import.\\Are you sure you want to exit?';
        LinktoLbl: label 'Map to';
        PayrollImportedMsg: label 'The Payroll Transactions have now been imported.';
        ShowGetSampleFile: Boolean;
        ShowResetLinks: Boolean;
        ResetLinksQst: label 'Do you want to reset all existing Linking suggestion?';
