...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Service Contract-Detail.rdlc';
    ...
    dataset
    {
        dataitem("Service Contract Header";"Service Contract Header")
        {
            ...
            dataitem(PageLoop;"Integer")
            {
                ...
                column(InvPeriod_ServeContrHdr;"Service Contract Header"."Invoice Period")
                {
                    IncludeCaption = true;
                }
                ...
                column(Status_ServeContrHdr;"Service Contract Header".Status)
                {
                    IncludeCaption = true;
                }
