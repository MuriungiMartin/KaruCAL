    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the width of one item unit when measured in the unit of measure in the Code field.';
                    Visible = false;
                }
                field(Length;Length)
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the length of one item unit when measured in the unit of measure in the Code field.';
                    Visible = false;
                }
                field(Cubage;Cubage)
                {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the weight of one item unit in the unit of measure in the Code field.';
                    Visible = false;
                }
            }
