...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application Dean Summary.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("First Degree Choice") order(ascending);
            ...
            begin
                  ...
                  repeat
                  Wexp:=WexpRec.Organisation+' '+WexpRec."Job Title"+' '+Format(WexpRec.From)+'-'+Format(WexpRec."To")+Wexp+',';
    ...
    var
        ...
        OtherQ: Text[250];
        Wexp: Text[250];
        OtherQRec: Record UnknownRecord61361;
        WexpRec: Record UnknownRecord61360;
        Reqstr: array [50] of Text[200];
        AdmReq: Record UnknownRecord61608;
        i: Integer;
        ProgName: Code[200];
