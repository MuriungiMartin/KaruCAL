        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Line Discount %";"Line Discount %")
                {
                    ApplicationArea = Basic,Suite;
                    Enabled = "Line Type" = 1;
                    ToolTip = 'Specifies the discount percent that is granted.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies if the price that is granted includes tax.';
                    Visible = false;
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the tax business posting group for customers who you want to apply the sales price to. This price includes tax.';
                    Visible = false;
                }
