...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Un Registered Students.rdlc';

    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            DataItemTableView = sorting(Programme) where(Registered=const(No),Reversed=filter(No),Blocked=const(0));
            RequestFilterFields = Programme,"Academic Year","Semester Filter","Settlement Type",Stage,"Programme Exam Category","Student Status";
