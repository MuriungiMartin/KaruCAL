...
Codeunit 13 "Gen. Jnl.-Post Batch"
{
    ...
    var
        ...
        Text010: label 'In order for the program to calculate tax, the entries must be separated by another document number or by an empty line.';
        ...
        Text029: label '%1 %2 posted on %3 includes more than one customer, vendor or IC Partner. ';
        ...
        PreviewMode: Boolean;
        ConfirmPostingOutsidePeriodQst: label 'The posting date of one or more journal lines is outside the current fiscal year. Do you want to continue?';
    ...
    var
        ...
        PostingOutsideFiscalYearConfirmed: Boolean;
    begin
    ...
    local procedure CheckAddExchRateBalance()
    begin
        with GenJnlLine do
    ...
    local procedure IsCustVendICAdded(GenJournalLine: Record "Gen. Journal Line"): Boolean
    begin
    ...
    local procedure CheckExpiredLine(var GenJournalLine: Record "Gen. Journal Line")
    begin
        with GenJournalLine do begin
          if not Find then
            FindSet;
    ...
    local procedure CheckLine(var GenJnlLine: Record "Gen. Journal Line";var PostingOutsideFiscalYearConfirmed: Boolean)
    begin
