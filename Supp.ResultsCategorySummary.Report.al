...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Supp. Results Category Summary.rdlc';

    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            DataItemTableView = sorting("Year of Admission","Student No.") order(ascending) where("Supp. Yearly Total Units Taken"=filter(<>0),"Supp. Yearly Remarks"=filter(<>""),Reversed=filter(No),"Supplementary Exists"=filter(Yes));
            ...
            column(StatusCode;ResultsStatus3."Supp. Rubric Caption 6")
            {
            }
            ...
            begin
                ...
                "ACA-Course Registration".CalcFields("ACA-Course Registration"."Supp. Yearly Total Units Taken");
                Clear(NextYear);
                ...
                ACASenateReportCounts.SetRange(StatusCode,"ACA-Course Registration"."Supp. Yearly Remarks");
                ...
                ACASenateReportStatusBuff.SetRange(StatusCode,"ACA-Course Registration"."Supp. Yearly Remarks");
                ...
                if not ACASenateReportStatusBuff.Find('-') then begin
                    ...
                    ACASenateReportStatusBuff.StatusCode:="ACA-Course Registration"."Supp. Yearly Remarks";
                ...
                ResultsStatus3.SetRange(Code,"ACA-Course Registration"."Supp. Yearly Remarks");
