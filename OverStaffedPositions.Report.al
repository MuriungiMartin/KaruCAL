...
Report 51440 "Over Staffed Positions"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Over Staffed Positions.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61056;UnknownTable61056)
        {
            ...
            column(Over_Staffed_PositionsCaption;Over_Staffed_PositionsCaptionLbl)
            {
            }
    ...
    var
        Over_Staffed_PositionsCaptionLbl: label 'Over Staffed Positions';
