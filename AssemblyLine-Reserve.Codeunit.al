...
Codeunit 926 "Assembly Line-Reserve"
{
    ...
    procedure CreateReservation(AssemblyLine: Record "Assembly Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[20];ForLotNo: Code[20])
    var
        ShipmentDate: Date;
    begin
    ...
    begin
        ...
        CreateReservationSetFrom(TrackingSpecification);
        CreateReservation(
          AsmLine,ProdOrderLine.Description,ProdOrderLine."Ending Date",ReservQty,ReservQtyBase,'','');
    end;
    ...
    begin
        ...
        CreateReservationSetFrom(TrackingSpecification);
        CreateReservation(
          AsmLine,AsmHeader.Description,AsmHeader."Due Date",ReservQty,ReservQtyBase,'','');
    end;
    ...
    begin
        ...
        CreateReservationSetFrom(TrackingSpecification);
        CreateReservation(
          AsmLine,TransLine.Description,TransLine."Receipt Date",ReservQty,ReservQtyBase,'','');
    end;
}
