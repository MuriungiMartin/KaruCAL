        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field(CaptionField;Caption)
                {
                    ...
                    StyleExpr = StyleTxt;
                    ToolTip = 'Specifies the caption of the field in Microsoft Dynamics NAV that the node in the currency exchange rate file must map to.';
                ...
                field(SourceField;Source)
                {
                    ...
                    ToolTip = 'Specifies the XPath to the XML node that must be mapped to the specified field in Microsoft Dynamics NAV.';
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies a rule for transforming imported text to a supported value before it can be mapped to a specified field in Microsoft Dynamics NAV. When you choose a value in this field, the same value is entered in the Transformation Rule field in the Data Exch. Field Mapping table and vice versa.';
                }
            }
        }
    }
