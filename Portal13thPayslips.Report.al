...
Report 77710 "Portal 13th Payslips"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Portal 13th Payslips.rdlc';

    dataset
    {
        dataitem(thePayCard;UnknownTable99200)
        {
            ...
            begin
                ...
                emp1.Reset;
                emp1.SetRange(emp1."No.",thePayCard."Employee Code");
            ...
            begin
                ...
                if thePayCard.GetFilter(thePayCard."Payroll Period")<>'' then
                  if Evaluate(PeriodFilter,(thePayCard.GetFilter(thePayCard."Payroll Period"))) then begin
                    end;
                //"prSalary Card"."Period Filter";
                ...
                //IF objPeriod.Closed=FALSE THEN ERROR('Period is still open');
