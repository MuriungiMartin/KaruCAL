    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the number series code used to assign document numbers to journal lines in this journal batch.';
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the reason code that has been entered on the item journal template.';
                }
            }
        }
        area(factboxes)
