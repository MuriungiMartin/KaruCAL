...
Page 1254 "Text-to-Account Mapping Wksh."
{
    ...
    actions
    {
        area(processing)
        {
            ...
            {
                ApplicationArea = Basic,Suite;
                Caption = 'Set Up Default Accounts';
                Image = Setup;
                Promoted = true;
                PromotedCategory = Process;
                PromotedIsBig = true;
                RunObject = Page "Purchases & Payables Setup";
                ToolTip = 'Specifies how to manage certain aspects of purchases and payables, such as how to calculate and post discounts and whether to round invoices.';
            }
        }
    }
