        ...
        area(content)
        {
            repeater(Control1)
            {
                field("No.";"No.")
                {
                    ...
                    ToolTip = 'Specifies the number of the date compression register.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the ID of the user who performed the date compression.';
                    Visible = false;
                }
                field("Source Code";"Source Code")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the code that is linked to the date compression batch job.';
                    Visible = false;
                }
            }
        }
