...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Archived Sales Quote.rdlc';
    ...
    var
        ...
        Sales_Line_Archive___VAT_Identifier_CaptionLbl: label 'Tax Identifier';
        ...
        VATAmountLine__VAT_Base__Control70CaptionLbl: label 'Tax Base';
        VATAmountLine__VAT_Amount__Control69CaptionLbl: label 'Tax Amount';
        ...
        VALVATAmountLCY_Control152CaptionLbl: label 'Tax Amount';
        VALVATBaseLCY_Control153CaptionLbl: label 'Tax Base';
        VATAmountLine__VAT____Control154CaptionLbl: label 'Tax %';
        VATAmountLine__VAT_Identifier__Control155CaptionLbl: label 'Tax Identifier';
