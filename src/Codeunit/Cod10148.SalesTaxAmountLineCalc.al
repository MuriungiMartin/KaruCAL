...
Codeunit 10148 "Sales Tax Amount Line Calc"
{
    ...
    procedure CalcSalesOrServLineSalesTaxAmountLine(var SalesTaxAmountLine: Record UnknownRecord10011;var TaxAreaLine: Record "Tax Area Line";TaxCountry: Option US,CA;var TaxArea: Record "Tax Area";var TaxJurisdiction: Record "Tax Jurisdiction";ExchangeFactor: Decimal)
    begin
    ...
    procedure CalcPurchLineSalesTaxAmountLine(var SalesTaxAmountLine: Record UnknownRecord10011;var TaxAreaLine: Record "Tax Area Line";TaxCountry: Option US,CA;var TaxArea: Record "Tax Area";var TaxJurisdiction: Record "Tax Jurisdiction";ExchangeFactor: Decimal;TaxDetail: Record "Tax Detail";PostingDate: Date)
    begin
        with SalesTaxAmountLine do begin
          Reset;
          if (LineType <> 0) and (TaxAreaCode <> '') then begin
    ...
    procedure SetTaxBaseAmount(var SalesTaxAmountLine: Record UnknownRecord10011;Value: Decimal;ExchangeFactor: Decimal;Increment: Boolean)
    begin
        with SalesTaxAmountLine do begin
          if Increment then
