...
Codeunit 133 "Send Incoming Document to OCR"
{
    ...
    var
        ...
        DoYouWantToSetupOCRQst: label 'The OCR Service is not not enabled.\\Do you want to open the OCR Service Setup window?';
        OCRServiceNotEnabledErr: label 'The OCR Service is not not enabled.';
