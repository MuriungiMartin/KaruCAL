...
Codeunit 5540 "Calc. Item Avail. Timeline"
{
    ...
    local procedure InsertTimelineEvent(var TempToTimelineEvent: Record "Timeline Event" temporary;TempFromInventoryEventBuffer: Record "Inventory Event Buffer" temporary)
    begin
