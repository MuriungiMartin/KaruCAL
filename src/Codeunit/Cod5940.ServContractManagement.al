...
Codeunit 5940 ServContractManagement
{
    ...
    local procedure LookUpAmountToCredit(ServiceContractHeader: Record "Service Contract Header";ServItemNo: Code[20];ItemNo: Code[20];PostingDate: Date;var LineAmount: Decimal;var CostAmount: Decimal;var UnitPrice: Decimal;var DiscountAmt: Decimal;var ServLedgEntryNo: Integer): Boolean
    var
        ServiceLedgerEntry: Record "Service Ledger Entry";
    begin
        LineAmount := 0;
    ...
    local procedure GoToNextBillToCustomer(var ServiceContractHeader: Record "Service Contract Header")
    var
