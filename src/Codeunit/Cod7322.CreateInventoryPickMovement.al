...
Codeunit 7322 "Create Inventory Pick/Movement"
{
    ...
    local procedure CalcInvtAvailability(WhseActivLine: Record "Warehouse Activity Line";LotNo: Code[20];SerialNo: Code[20]): Decimal
    var
        Item2: Record Item;
    ...
    local procedure CalcQtyAvailToPickOnBins(WhseActivLine: Record "Warehouse Activity Line";LotNo: Code[20];SerialNo: Code[20];RemQtyToPickBase: Decimal): Decimal
    var
