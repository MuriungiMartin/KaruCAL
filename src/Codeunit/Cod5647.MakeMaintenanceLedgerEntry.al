...
Codeunit 5647 "Make Maintenance Ledger Entry"
{
    ...
    procedure CopyFromFAJnlLine(var MaintenanceLedgEntry: Record "Maintenance Ledger Entry";var FAJnlLine: Record "FA Journal Line")
    begin
    ...
    procedure CopyFromGenJnlLine(var MaintenanceLedgEntry: Record "Maintenance Ledger Entry";var GenJnlLine: Record "Gen. Journal Line")
    begin
        with MaintenanceLedgEntry do begin
          Init;
          "User ID" := UserId;
