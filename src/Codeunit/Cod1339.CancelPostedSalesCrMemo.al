...
Codeunit 1339 "Cancel Posted Sales Cr. Memo"
{
    ...
    var
        AlreadyCancelledErr: label 'You cannot cancel this posted sales credit memo because it has already been canceled.';
        ...
        InvalidDimCodeCancelErr: label 'You cannot cancel this posted sales credit memo because the dimension rule setup for account ''%1'' %2 prevents %3 %4 from being canceled.', Comment='%1 = Table caption %2 = Account number %3 = Item no. %4 = Item description.';
    ...
    local procedure TestCustomerPostingGroup(SalesCrMemoLine: Record "Sales Cr.Memo Line";CustomerPostingGr: Code[10])
    var
