...
Codeunit 27000 "Export Accounts"
{
    ...
    begin
        ...
        CreateXMLHeader(TempXMLBuffer,CatalogoNodeTxt,CatalogoNamespaceTxt,Year,Month,'1.1');
    ...
    begin
        ...
        CreateXMLHeader(TempXMLBuffer,BalanzaNodeTxt,BalanzaNamespaceTxt,Year,Month,'1.1');
        ...
        if not ClosingBalanceSheet then begin
          ...
          TempXMLBuffer.AddAttribute('Mes','13');
        end;
    ...
    procedure ExportTransactions(Year: Integer;Month: Integer;RequestType: Option AF,FC,DE,CO;OrderNumber: Text[13];ProcessNumber: Text[10])
    var
    ...
    begin
        ...
        CreateXMLHeader(TempXMLBuffer,PolizasNodeTxt,PolizasNamespaceTxt,Year,Month,'1.1');
    ...
    procedure ExportAuxiliaryAccounts(Year: Integer;Month: Integer;RequestType: Option AF,FC,DE,CO;OrderNumber: Text[13];ProcessNumber: Text[10])
    var
        GLAccount: Record "G/L Account";
        GLAccountBalanceIni: Record "G/L Account";
        GLAccountBalanceFin: Record "G/L Account";
    ...
    begin
        ...
        CreateXMLHeader(TempXMLBuffer,AuxiliaryAccountNodeTxt,AuxiliaryAccountNamespaceTxt,Year,Month,'1.1');
        TempXMLBuffer.AddAttribute('TipoSolicitud',Format(RequestType));
        if RequestType in [Requesttype::AF,Requesttype::FC] then begin
          if OrderNumber <> '' then
            TempXMLBuffer.AddAttribute('NumOrden',OrderNumber)
    ...
    begin
        ...
        TempXMLBuffer.AddAttribute('xsi:schemaLocation',
          FullNameSpace + ' ' + 'http://' + FullNameSpace + '/' + NodeNameSpace + '_1_1.xsd');
