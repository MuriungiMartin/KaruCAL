...
Codeunit 2501 ExtensionMarketplaceMgmt
{
    ...
    var
        ...
        Token: Option PUBID,AID,AV,PACKID,PAPPID;
    ...
    [TryFunction]
    local procedure TryParseApplicationId(ApplicationId: Text;Position: Integer;ExpectedToken: Option PUBID,AID,AV,PACKID,PAPPID)
    var
        actualToken: Text;
    begin
