...
Codeunit 1217 "Pre-map Incoming Purch. Doc"
{
    ...
    var
        ...
        InvalidCompanyInfoVATRegNoErr: label 'The customer''s tax registration number %1 on the incoming document does not match the Tax Registration No. in the Company Information window.', Comment='%1 VAT Registration Number (format could be AB###### or ###### or AB##-##-###)';
        ...
        BuyFromVendorNotFoundErr: label 'Cannot find buy-from vendor ''%1'' based on the vendor''s GLN %2 or tax registration number %3 on the incoming document. Make sure that a card for the vendor exists with the corresponding GLN or Tax Registration No.', Comment='%1 Vendor name (e.g. London Postmaster), %2 Vendor''s GLN (13 digit number), %3 Vendor''s VAT Registration Number';
        PayToVendorNotFoundErr: label 'Cannot find  vendor ''%1'' based on the vendor''s GLN %2 or tax registration number %3 on the incoming document. Make sure that a card for the vendor exists with the corresponding GLN or Tax Registration No.', Comment='%1 Vendor name (e.g. London Postmaster), %2 Vendor''s GLN (13 digit number), %3 Vendor''s VAT Registration Number';
        ...
        MissingCompanyInfoSetupErr: label 'You must fill either GLN or Tax Registration No. in the Company Information window.';
        ...
        UnableToFindTotalAmountErr: label 'The incoming document has no total amount excluding Tax.';
