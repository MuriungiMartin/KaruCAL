...
Codeunit 764 "Aged Acc. Payable"
{
    ...
    local procedure CalculateAgedAccPayablePerVendor(VendorNo: Code[20];CustomerGroupCode: Code[10];StartDate: Date;PeriodLength: Text[1];NoOfPeriods: Integer;var TempEntryNoAmountBuffer: Record "Entry No. Amount Buffer" temporary)
    var
    ...
    local procedure InsertAmountBuffer(Index: Integer;BussUnitCode: Code[10];AmountLCY: Decimal;StartDate: Date;EndDate: Date;var TempEntryNoAmountBuffer: Record "Entry No. Amount Buffer" temporary)
    var
        AgedAccReceivable: Codeunit "Aged Acc. Receivable";
    begin
