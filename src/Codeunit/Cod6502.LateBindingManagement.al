...
Codeunit 6502 "Late Binding Management"
{
    ...
    procedure ReleaseForReservation(ItemNo: Code[20];VariantCode: Code[10];LocationCode: Code[10];SerialNo: Code[20];LotNo: Code[20];QtyToRelease: Decimal) AllocationsChanged: Boolean
    var
