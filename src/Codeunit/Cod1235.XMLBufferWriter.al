...
Codeunit 1235 "XML Buffer Writer"
{
    ...
    local procedure ParseCurrentXmlNode(var XMLBuffer: Record "XML Buffer";ParentXMLBuffer: Record "XML Buffer";var LastInsertedXMLBufferElement: Record "XML Buffer";var ElementNumber: Integer;Depth: Integer)
    begin
        if IsParentElement(Depth) then
          exit;
    ...
    local procedure ReadAndInsertXmlElement(var XMLBuffer: Record "XML Buffer";ParentXMLBuffer: Record "XML Buffer";var ElementNumber: Integer;var InsertedXMLBufferElement: Record "XML Buffer")
    var
    ...
    procedure InsertElement(var XMLBuffer: Record "XML Buffer";ParentXMLBuffer: Record "XML Buffer";ElementNumber: Integer;ElementDepth: Integer;ElementNameAndNamespace: Text[250];ElementValue: Text[250])
    var
