...
Codeunit 398 "Sales Tax Calculate"
{
    ...
    var
        ...
        TempTaxAmountDifference: Record UnknownRecord10012 temporary;
    ...
    var
        SalesTaxAmountLine2: Record UnknownRecord10011 temporary;
        TaxDetail: Record "Tax Detail";
        AddedTaxAmount: Decimal;
    ...
    procedure GetSummarizedSalesTaxTable(var SummarizedSalesTaxAmtLine: Record UnknownRecord10011)
    var
        TaxJurisdiction: Record "Tax Jurisdiction";
        RemTaxAmt: Decimal;
    ...
    procedure GetSalesTaxAmountLineTable(var SalesTaxLine2: Record UnknownRecord10011 temporary)
    begin
        TempSalesTaxLine.Reset;
        if TempSalesTaxLine.FindSet then
          repeat
    ...
    procedure PutSalesTaxAmountLineTable(var SalesTaxLine2: Record UnknownRecord10011 temporary;ProductArea: Integer;DocumentType: Integer;DocumentNo: Code[20])
    begin
        TempSalesTaxLine.Reset;
        TempSalesTaxLine.DeleteAll;
    ...
    procedure HandleRoundTaxUpOrDown(var SalesTaxAmountLine: Record UnknownRecord10011;RoundTax: Option "To Nearest",Up,Down;TotalTaxAmount: Decimal;TaxAreaCode: Code[20];TaxGroupCode: Code[10])
    var
