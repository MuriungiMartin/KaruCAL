...
Codeunit 550 "VAT Rate Change Conversion"
{
    ...
    var
        ...
        Text0008: label 'There must be an entry in the %1 table for the combination of Tax business posting group %2 and Tax product posting group %3.';
    ...
    var
        ...
        NewVATProdPotingGroup: Code[10];
        NewGenProdPostingGroup: Code[10];
    ...
    local procedure AddNewSalesLine(SalesLine: Record "Sales Line";VATProdPostingGroup: Code[10];GenProdPostingGroup: Code[10])
    var
    ...
    local procedure AddNewPurchaseLine(PurchaseLine: Record "Purchase Line";VATProdPostingGroup: Code[10];GenProdPostingGroup: Code[10])
    var
    ...
    local procedure LineInScope(GenProdPostingGroup: Code[10];VATProdPostingGroup: Code[10];ConvertGenProdPostingGroup: Boolean;ConvertVATProdPostingGroup: Boolean): Boolean
    begin
        if ConvertGenProdPostingGroup then
    ...
    local procedure AddNewServiceLine(ServiceLine: Record "Service Line";VATProdPostingGroup: Code[10];GenProdPostingGroup: Code[10])
    var
