...
Codeunit 1620 "PEPPOL Validation"
{
    ...
    var
        ...
        MissingCustGLNOrVATRegNoErr: label 'You must specify either GLN or Tax Registration No. for Customer %1.';
        MissingCompInfGLNOrVATRegNoErr: label 'You must specify either GLN or Tax Registration No. in %1.', Comment='%1=Company Information';
