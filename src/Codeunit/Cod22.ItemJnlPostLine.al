...
Codeunit 22 "Item Jnl.-Post Line"
{
        ...
        with ItemJnlLine do begin
          ...
          if LastOperation and ("Output Quantity" <> 0) then begin
            ...
            if Location."Bin Mandatory" and (not CalledFromInvtPutawayPick) then
              Codeunit.Run(Codeunit::"Whse. Jnl.-Register Line",WhseJnlLine);
          end;
        end;
    end;
        ...
        with ValueEntry do begin
          if ("Valued Quantity" > 0) and not ("Expected Cost" or ItemJnlLine.Adjustment) then begin
            ...
            if (("Item Ledger Entry Type" in
                ...
                ("Item Ledger Entry Type" = "item ledger entry type"::Output) and ("Invoiced Quantity" > 0)) and
    ...
    begin
        ...
        with ItemJnlLine do begin
          ...
          XferCustomFields.ItemJnlLineTOItemLedgEntry(ItemJnlLine,ItemLedgEntry);
        end;
