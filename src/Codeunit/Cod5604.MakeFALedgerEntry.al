...
Codeunit 5604 "Make FA Ledger Entry"
{
    ...
    procedure CopyFromFAJnlLine(var FALedgEntry: Record "FA Ledger Entry";var FAJnlLine: Record "FA Journal Line")
    begin
    ...
    procedure CopyFromGenJnlLine(var FALedgEntry: Record "FA Ledger Entry";var GenJnlLine: Record "Gen. Journal Line")
    var
