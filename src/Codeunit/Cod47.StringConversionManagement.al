...
Codeunit 47 StringConversionManagement
{
    ...
    procedure GetPaddedString(StringToModify: Text[250];PadLength: Integer;PadCharacter: Text[1]) FinalString: Text[250]
    begin
    ...
    procedure RemoveDecimalFromString(StringToModify: Text[250];PadLength: Integer;PadCharacter: Text[1]) FinalString: Text[250]
    var
        TempNumeric: Decimal;
        TempInteger: Integer;
    begin
