...
Codeunit 50106 "BankAlertMgt FP"
{
    ...
    var
        ...
        TellerSetup: Record UnknownRecord61712;
        BuffAlert: Record UnknownRecord61701;
        Selection: Boolean;
        LineNo: Integer;
    ...
    begin
        ...
        if BuffAlert.Find('-') then
          begin
            repeat
              if BuffAlert."Curr. Balance"<=BuffAlert."Max. Balance" then
                begin
                  BuffAlert.Mark(true);
                  BuffAlert.Modify;
                end;
    ...
    procedure CreateCashRequest(var Rec: Record UnknownRecord61701;CurrUser: Code[20]): Code[20]
    var
        Request: Record UnknownRecord61706;
        NoSeriesMgt: Codeunit NoSeriesManagement;
        TSetup: Record UnknownRecord61712;
        CSSetup: Record UnknownRecord61713;
        UserSelection: Boolean;
        Req: Record UnknownRecord61706;
    begin
    ...
    var
        Requests: Record UnknownRecord61706;
    begin
    ...
    procedure CreateCashIssue(var Request: Record UnknownRecord61706)
    var
        Issue: Record UnknownRecord61707;
        NoSeriesMgt: Codeunit NoSeriesManagement;
        CSSetup: Record UnknownRecord61713;
        Selection: Boolean;
    begin
    ...
    procedure CreateCashReceipt(var Issue: Record UnknownRecord61707)
    var
        NoSeriesMgt: Codeunit NoSeriesManagement;
        CSSetup: Record UnknownRecord61713;
        Receipt: Record UnknownRecord61708;
        Selection: Boolean;
    begin
        ...
        case Selection of
            true://user wishes to view hence show the form
              begin
               // PAGE.RUN(DATABASE::"Cancelled Travel Adv Vouchers",Receipt);
              end;
