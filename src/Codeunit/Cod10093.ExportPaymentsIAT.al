...
Codeunit 10093 "Export Payments (IAT)"
{
    ...
    var
        ...
        Text001: label 'is not valid', Comment='Field Value is not valid';
    ...
    local procedure AddToPrnString(var PrnString: Text[250];SubString: Text[250];StartPos: Integer;Length: Integer;Justification: Option Left,Right;Filler: Text[1])
    var
        I: Integer;
        SubStrLen: Integer;
    begin
