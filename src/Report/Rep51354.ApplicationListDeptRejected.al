...
Report 51354 "Application List Dept Rejected"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Dept Rejected.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const("Department Rejected"));
