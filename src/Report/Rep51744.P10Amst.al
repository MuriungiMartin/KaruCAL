...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/P.10 A mst.rdlc';
    ...
    var
        ...
        PAYE: Decimal;
        TotPAYE: Decimal;
        CompanySetup: Record UnknownRecord61119;
        YR: Integer;
        TotalCumm: Decimal;
        Index: Integer;
        TotPayeTemp: Decimal;
        EmpLedgerentry: Record UnknownRecord61092;
        GrossPay: Decimal;
        EmpCalc: Record UnknownRecord61105;
        MyPAYE: Decimal;
        MyPAYETot: Decimal;
        MyPGROSSTot: Decimal;
        "Employee Payroll": Record UnknownRecord61118;
