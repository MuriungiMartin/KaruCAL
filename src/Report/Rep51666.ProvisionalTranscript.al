...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Provisional Transcript.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            ...
            column(TranscriptRemarks;"ACA-Course Registration"."Transcript Remarks")
            {
            }
            ...
            column(CumSc;"ACA-Course Registration"."Cumm Status")
            {
            }
            ...
            column(RegAcadLabel;'Dean, '+SchoolName)
            {
            }
            ...
            dataitem(UnknownTable61549;UnknownTable61549)
            {
                ...
                column(CF;"ACA-Student Units"."No. Of Units")
                {
                }
            ...
            begin
                ...
                SelectedStages:="ACA-Course Registration".GetFilter("ACA-Course Registration"."Stage Filter");
                ...
                end else if ProgStages."Final Stage"=true then begin
                PassRemark:="ACA-Course Registration".Award;//'Recommendation: '+"ACA-Course Registration".Award;
                end;
                if "ACA-Course Registration"."Cum Units Failed">0 then begin
                PassRemark:="ACA-Course Registration"."Exam Status";//'Recommendation: '+"ACA-Course Registration"."Exam Status";
                end;
