...
Report 51359 "Application List Provision Adm"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Provision Adm.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const("Provisional Admission"));
