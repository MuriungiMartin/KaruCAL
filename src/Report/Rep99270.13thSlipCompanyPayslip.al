...
Report 99270 "13thSlip-Company Payslip"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/13thSlip-Company Payslip.rdlc';

    dataset
    {
        dataitem(UnknownTable99250;UnknownTable99250)
        {
            ...
            begin
                ...
                Clear(DetDate);
                DetDate:=Format("PRL-13thSlip Payroll Periods"."Period Name")+' ('+Format(NoOfInstalment)+')';
                repeat
                begin
            ...
            begin
                ...
                "PRL-13thSlip Payroll Periods".SetFilter("PRL-13thSlip Payroll Periods"."Date Openned",'=%1',SelectedPeriod);
                "PRL-13thSlip Payroll Periods".SetFilter("PRL-13thSlip Payroll Periods"."Current Instalment",'=%1',NoOfInstalment);
            end;
        }
    }
    ...
    var
        ...
        NoOfColumns: Integer;
        ColumnNo: Integer;
        prPeriod_Transactions: Record UnknownRecord99252;
}
