...
Report 51384 "HMS Referral Request Form"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HMS Referral Request Form.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61407;UnknownTable61407)
        {
            ...
            dataitem(UnknownTable61415;UnknownTable61415)
            {
                DataItemLink = "Treatment No."=field("Treatment No.");
                column(ReportForNavId_6636; 6636)
                {
                }
            }
