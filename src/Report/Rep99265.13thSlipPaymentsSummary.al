...
Report 99265 "13thSlip - Payments Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/13thSlip - Payments Summary.rdlc';
        ...
        dataitem(UnknownTable99252;UnknownTable99252)
        {
            ...
            begin
                    ...
                    empName:=emps."First Name"+' '+emps."Middle Name"+' '+emps."Last Name";
                     ...
                     if not (((("PRL-13thSlip Period Trans."."Group Order"=1) and
                     ("PRL-13thSlip Period Trans."."Sub Group Order"<>1)) or
                    ("PRL-13thSlip Period Trans."."Group Order"=3) or
                     (("PRL-13thSlip Period Trans."."Group Order"=4) and
                      ("PRL-13thSlip Period Trans."."Sub Group Order"<>0)))) then begin
                         CurrReport.Skip;
                         end;
