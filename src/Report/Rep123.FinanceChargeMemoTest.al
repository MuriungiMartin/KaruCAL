...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Finance Charge Memo - Test.rdlc';
        ...
        dataitem("Finance Charge Memo Header";"Finance Charge Memo Header")
        {
            ...
            dataitem(PageCounter;"Integer")
            {
                ...
                dataitem(BeginningText;"Finance Charge Memo Line")
                {
                    ...
                    column(ReportForNavId_9507; 9507)
                    {
                    }
                ...
                dataitem("Finance Charge Memo Line";"Finance Charge Memo Line")
                {
                    ...
                    DataItemLinkReference = "Finance Charge Memo Header";
                    DataItemTableView = sorting("Finance Charge Memo No.","Line No.");
                    column(ReportForNavId_9546; 9546)
                    {
                    }
                ...
                dataitem(ReminderLine2;"Finance Charge Memo Line")
                {
                    ...
                    DataItemLinkReference = "Finance Charge Memo Header";
                    DataItemTableView = sorting("Finance Charge Memo No.","Line No.");
                    column(ReportForNavId_8620; 8620)
                    {
                    }
    ...
    var
        ...
        VATAmountLine__VAT_Amount__Control55CaptionLbl: label 'Tax Amount';
        VATAmountLine__VAT_Base__Control56CaptionLbl: label 'Tax Base';
        VAT_Amount_SpecificationCaptionLbl: label 'Tax Amount Specification';
        VATAmountLine__VAT___CaptionLbl: label 'Tax %';
        VATAmountLine__Amount_Including_VAT__Control73CaptionLbl: label 'Amount Including Tax';
        VATAmountLine__VAT_Base__Control49CaptionLbl: label 'Total';
        VALVATAmountLCY_Control92CaptionLbl: label 'Tax Amount';
        VALVATBaseLCY_Control93CaptionLbl: label 'Tax Base';
        VATAmountLine__VAT____Control94CaptionLbl: label 'Tax %';
