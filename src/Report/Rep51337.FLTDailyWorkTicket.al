...
Report 51337 "FLT Daily Work Ticket"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/FLT Daily Work Ticket.rdlc';

    dataset
    {
        dataitem(UnknownTable61812;UnknownTable61812)
        {
            ...
            dataitem(UnknownTable61813;UnknownTable61813)
            {
                ...
                begin
                    ...
                    if offCount=1 then
                      begin
                      Off1:=Address[1][1];
                      end else if offCount=2 then
                      begin
                      Off2:=Address[1][1];
                      end
                      else if  offCount=3 then
                      begin
                      Off3:=Address[1][1];
                      end;
            ...
            dataitem(UnknownTable61811;UnknownTable61811)
            {
                DataItemLink = "Ticket No."=field("Ticket No.");
                ...
                begin
                    ...
                    if DriveCount=1 then
                      begin
                      Drive1:=Addr[1][1];
                      end else if DriveCount=2 then
                      begin
                      Drive2:=Addr[2][1];
                      end
                      else if  DriveCount=3 then
                      begin
                      Drive3:=Addr[1][1];
                      end
                      else if DriveCount=4 then
                      begin
                      Drive4:=Addr[2][1];
                      end else if DriveCount=5 then
                      begin
                      Drive5:=Addr[1][1];
                      end
                      else if  DriveCount=6 then
                      begin
                      Drive6:=Addr[2][1];
                      end;
            ...
            dataitem(UnknownTable61810;UnknownTable61810)
            {
                DataItemLink = "Ticket No."=field("Ticket No.");
