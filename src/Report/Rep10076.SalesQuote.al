        ...
        dataitem("Sales Header";"Sales Header")
        {
            ...
            dataitem("Sales Line";"Sales Line")
            {
                ...
                dataitem(SalesLineComments;"Sales Comment Line")
                {
                    ...
                    DataItemTableView = sorting("Document Type","No.","Document Line No.","Line No.") where("Document Type"=const(Quote),"Print On Quote"=const(Yes));
            ...
            dataitem("Sales Comment Line";"Sales Comment Line")
            {
                ...
                DataItemTableView = sorting("Document Type","No.","Document Line No.","Line No.") where("Document Type"=const(Quote),"Print On Quote"=const(Yes),"Document Line No."=const(0));
