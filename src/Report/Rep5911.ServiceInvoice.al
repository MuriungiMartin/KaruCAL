...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Service - Invoice.rdlc';
    ...
    dataset
    {
        dataitem("Service Invoice Header";"Service Invoice Header")
        {
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                column(ReportForNavId_159; 159)
                {
                }
                dataitem(PageLoop;"Integer")
                {
                    DataItemTableView = sorting(Number) where(Number=const(1));
                    column(ReportForNavId_160; 160)
                    {
                    }
                    ...
                    column(ServiceInvoicePercentage;StrSubstNo(Text004,CopyText))
                    {
                    }
                    ...
                    dataitem("Service Invoice Line";"Service Invoice Line")
                    {
                        ...
                        column(LineLineNo_ServiceInvoice;"Service Invoice Line"."Line No.")
                        {
                        }
    ...
    var
        ...
        Text027: label 'Tax %';
        Text028: label 'Tax Base';
        Text029: label 'Tax Amount';
        Text030: label 'Tax Amount Specification';
        Text031: label 'Tax Identifier';
