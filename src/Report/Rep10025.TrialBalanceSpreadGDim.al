...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Trial Balance, Spread G. Dim..rdlc';
    ...
    dataset
    {
        dataitem("G/L Account";"G/L Account")
        {
            ...
            column(CurrReport_PAGENO_Control1016;CurrReport.PageNo)
            {
            }
            ...
            column(CurrReport_PAGENO_Control1016Caption;CurrReport_PAGENO_Control1016CaptionLbl)
            {
            }
    ...
    var
        ...
        CurrReport_PAGENO_Control1016CaptionLbl: label 'Page';
