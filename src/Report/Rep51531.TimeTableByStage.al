...
Report 51531 "Time Table - By Stage"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Time Table - By Stage.rdlc';
    ...
    dataset
    {
        ...
        dataitem(UnknownTable61517;UnknownTable61517)
        {
            ...
            begin
                LName:='';
                LUnits.Reset;
                LUnits.SetRange(LUnits.Unit,"ACA-Units/Subjects".Code);
                if LUnits.Find('-') then begin
                if Emp.Get(LUnits.Lecturer) then
                LName:=Emp."First Name" + ' ' + Emp."Middle Name" + ' ' + Emp."Last Name";
                end;
            end;
