...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Bank Reconciliation.rdlc';
    Caption = 'Bank Reconciliation';

    dataset
    {
        dataitem(UnknownTable10123;UnknownTable10123)
        {
            DataItemTableView = sorting("Bank Account No.","Statement No.");
            RequestFilterFields = "Bank Account No.","Statement No.";
            column(ReportForNavId_9597; 9597)
            {
            }
            ...
            column(DataItem1020025;G_L_Balance______Positive_Adjustments_____Negative_Bal__Adjustments_______Negative_Adjustments_____Positive_Bal__Adjustmen000Lbl)
            {
            }
            ...
            dataitem(Checks;UnknownTable10124)
            {
            ...
            dataitem(Deposits;UnknownTable10124)
            {
                DataItemLink = "Bank Account No."=field("Bank Account No."),"Statement No."=field("Statement No.");
            ...
            dataitem(Adjustments;UnknownTable10124)
            {
                DataItemLink = "Bank Account No."=field("Bank Account No."),"Statement No."=field("Statement No.");
            ...
            dataitem(OutstandingChecks;UnknownTable10124)
            {
                DataItemLink = "Bank Account No."=field("Bank Account No."),"Statement No."=field("Statement No.");
            ...
            dataitem(OutstandingDeposits;UnknownTable10124)
            {
                DataItemLink = "Bank Account No."=field("Bank Account No."),"Statement No."=field("Statement No.");
    ...
    var
        ...
        G_L_Balance______Positive_Adjustments_____Negative_Bal__Adjustments_______Negative_Adjustments_____Positive_Bal__Adjustmen000Lbl: label 'Difference';
