...
Report 51377 "Application List Dean Pending"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Dean Pending.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const(Dean));
