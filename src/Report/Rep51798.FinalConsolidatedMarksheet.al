...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Final Consolidated Marksheet.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            ...
            RequestFilterFields = "Year Of Study","Academic Year","Student No.",Programme,Stage,Semester,Session,Options;
            ...
            column(CountedDistinct;"ACA-Course Registration"."Student No."+"ACA-Course Registration"."Yearly Remarks")
            {
            }
            ...
            column(YearlyPassed;"ACA-Course Registration"."Yearly Passed Units")
            {
            }
            ...
            column(CoursesFailed;"ACA-Course Registration"."Yearly Failed Courses")
            {
            }
            ...
            dataitem(UnknownTable61549;UnknownTable61549)
            {
                ...
                column(UnitDesc;UnitsSetup.Desription)
                {
                }
                ...
                begin
                    ...
                    //ELSE
                      ...
                      if (("ACA-Course Registration"."Yearly Remarks"='EXPELLED') or
                       ...
                       ("ACA-Course Registration"."Yearly Remarks"='EXPULSION')) then ScoreLabel:='-';
                      // IF "ACA-Student Units".Description='' THEN BEGIN
                         UnitsSetup.Reset;
                         UnitsSetup.SetRange(Code,"ACA-Student Units".Unit);
                         UnitsSetup.SetRange("Programme Code","ACA-Student Units".Programme);
                         UnitsSetup.SetFilter(Desription,'<>%1','');
                         if UnitsSetup.Find('-') then "ACA-Student Units".Description:=UnitsSetup.Desription;
                       //  END;
                end;
            }
            ...
            begin
                ...
                if ACAResultsStatus.Find('-') then;
                  ...
                  if (("ACA-Course Registration"."Yearly Remarks"='EXPELLED') or
                   ...
                   "ACA-Course Registration"."Yearly Total Units Taken":=0;
                "ACA-Course Registration"."Yearly Weighted Total":=0;
                "ACA-Course Registration"."Yearly Passed Units":=0;
                "ACA-Course Registration"."Yearly Failed Units":=0;
                "ACA-Course Registration"."Yearly CF% Failed":=0;
                "ACA-Course Registration"."Yearly Failed Courses":=0;
                "ACA-Course Registration"."Yearly Curr. Average":=0;
                   end;
    ...
    var
        ...
        FacDesc: Code[20];
        UnitsSetup: Record UnknownRecord61517;
}
