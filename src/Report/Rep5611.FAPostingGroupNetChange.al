...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/FA Posting Group - Net Change.rdlc';
    ...
    dataset
    {
        ...
        dataitem(Headline;"Integer")
        {
            ...
            column(ReportForNavId_4190; 4190)
            {
            }
    ...
    local procedure InsertAmount(FAPostingGrCode: Code[10];FieldCaptionText: Text[80];AccNo: Code[20];PostAmount: Decimal)
    begin
    ...
    local procedure CalculateAccount(FAPostingGrCode: Code[10];var FieldCaptionText: Text[50];var AccNo: Code[20];var PostAmount: Decimal)
    begin
        case Type of
          Type::Acq:
            begin
    ...
    procedure SkipInsertAmount(FAPostingGrCode: Code[10];AccNo: Code[20];PostAmount: Decimal): Boolean
    begin
