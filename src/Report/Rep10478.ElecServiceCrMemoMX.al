...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Elec. Service Cr Memo MX.rdlc';
        ...
        dataitem("Service Cr.Memo Header";"Service Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(STRSUBSTNO_Text006_FORMAT_CurrReport_PAGENO__;StrSubstNo(Text006,Format(CurrReport.PageNo)))
                    {
                    }
            ...
            begin
                ...
                TempBlob.Blob := "Service Cr.Memo Header"."Original String";
                BlobMgt.Read(OriginalStringBigText,TempBlob);
                Clear(DigitalSignatureBigText);
                TempBlob.Blob := "Service Cr.Memo Header"."Digital Stamp SAT";
                BlobMgt.Read(DigitalSignatureBigText,TempBlob);
                TempBlob.Blob := "Digital Stamp PAC";
    ...
    var
        ...
        Text007: label 'Total %1 Excl. Tax';
        ...
        VATAmountLine__VAT_Base__Control105CaptionLbl: label 'Tax Base';
        VATAmountLine__VAT_Amount__Control106CaptionLbl: label 'Tax Amount';
