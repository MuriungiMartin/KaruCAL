...
Report 51093 "Quotation Analysis Report 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Quotation Analysis Report 2.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Line";"Purchase Line")
        {
            ...
            column(Purchase_Header___Buy_from_Vendor_No___Control1000000014;"Purchase Header"."Buy-from Vendor No.")
            {
            }
