...
Report 77334 "HRM-Staff Clearance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HRM-Staff Clearance.rdlc';

    dataset
    {
        dataitem(UnknownTable77300;UnknownTable77300)
        {
            DataItemTableView = sorting("No.");
            RequestFilterFields = "PF No.";
            ...
            column(Clearance_Header__Student_No__;"PF No.")
            {
            }
            ...
            column(Clearance_Header__Student_No__Caption;FieldCaption("PF No."))
            {
            }
