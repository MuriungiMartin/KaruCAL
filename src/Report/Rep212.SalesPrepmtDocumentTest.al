...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales Prepmt. Document Test.rdlc';
    ...
    var
        ...
        Text003: label 'Total %1 Excl. Tax';
        Text004: label 'Total %1 Incl. Tax';
        DimText: Text[120];
        ...
        VATAmountLine__VAT_Amount__Control134CaptionLbl: label 'Tax Amount';
        VATAmountLine__VAT_Base__Control135CaptionLbl: label 'Tax Base';
