...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Yearly Fee Statement.rdlc';
        ...
        dataitem(Customer;Customer)
        {
            ...
            dataitem("Cust. Ledger Entry";"Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    Clear(AcademicYear);
                    AcademicYears.Reset;
                    AcademicYears.SetFilter(AcademicYears.From,'=%1|<%2',"Cust. Ledger Entry"."Posting Date","Cust. Ledger Entry"."Posting Date");
                    AcademicYears.SetFilter(AcademicYears."To",'=%1|>%2',"Cust. Ledger Entry"."Posting Date","Cust. Ledger Entry"."Posting Date");
                    ...
                    //CustBalanceLCY := CustBalanceLCY + "Amount (LCY)";
                    CustBalanceLCY:=CustBalanceLCY+"Cust. Ledger Entry"."Debit Amount"+("Cust. Ledger Entry"."Credit Amount"*-1);
    ...
    var
        ...
        AcademicYears: Record UnknownRecord61382;
}
