...
Report 51761 "prPayrollSummary6 mst"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/prPayrollSummary6 mst.rdlc';
        ...
        dataitem("Dimension Value";"Dimension Value")
        {
            ...
            dataitem(UnknownTable61118;UnknownTable61118)
            {
                ...
                begin
                    ...
                    //PeriodTrans.SETRANGE(PeriodTrans."Location/Division","Location/Division Code");
                    ...
                    if PeriodTrans.Find('-') then
                      ...
                      //Basic Pay************************START
                        ...
                        begin
                          ...
                          TotBasicPay:=TotBasicPay+PeriodTrans.Amount;
                     ...
                     //CYRUS MODIFIED
                       ...
                       //Pension *************************** please redo this ;-) dennis tihihihi
                        ...
                        //Total Deductions***********************
                        if ((PeriodTrans."Group Order"=8)  and (PeriodTrans."Sub Group Order"=9)) or (PeriodTrans."Transaction Code"='PAYE')
                        or (PeriodTrans."Transaction Code"='PAYE50%') or (PeriodTrans."Transaction Code"='PAYE-CONT') or
                        (PeriodTrans."Transaction Code"='PAYE-EXP')then
