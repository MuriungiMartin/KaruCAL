...
Report 99273 "Vendor - Detail Trial Balance2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Vendor - Detail Trial Balance2.rdlc';
    ...
    dataset
    {
        dataitem(Vendor;Vendor)
        {
            ...
            dataitem("Vendor Ledger Entry";"Vendor Ledger Entry")
            {
                ...
                DataItemTableView = sorting("Vendor No.","Posting Date") where("Is a Medical Claim"=filter(Yes));
                ...
                dataitem("Detailed Vendor Ledg. Entry";"Detailed Vendor Ledg. Entry")
                {
                    ...
                    DataItemTableView = sorting("Vendor Ledger Entry No.","Entry Type","Posting Date") where("Entry Type"=const("Correction of Remaining Amount"),"Is a Medical Claim"=filter(Yes));
                    ...
                    begin
                        SetFilter("Posting Date",VendDateFilter);
                         ...
                         if TransactionCategory = Transactioncategory::"Medical Claims" then
                           "Detailed Vendor Ledg. Entry".SetFilter("Detailed Vendor Ledg. Entry"."Is a Medical Claim",'%1',true);
                    end;
                }
                dataitem("Detailed Vendor Ledg. Entry2";"Detailed Vendor Ledg. Entry")
                {
                    DataItemLink = "Vendor Ledger Entry No."=field("Entry No.");
                    DataItemTableView = sorting("Vendor Ledger Entry No.","Entry Type","Posting Date") where("Entry Type"=const("Appln. Rounding"),"Is a Medical Claim"=filter(Yes));
                    ...
                    begin
                        SetFilter("Posting Date",VendDateFilter);
                         ...
                         if TransactionCategory = Transactioncategory::"Medical Claims" then
                           "Detailed Vendor Ledg. Entry2".SetFilter("Detailed Vendor Ledg. Entry2"."Is a Medical Claim",'%1',true);
                    end;
                }
                ...
                begin
                    ...
                    CurrReport.CreateTotals(VendAmount,"Amount (LCY)");
                     if TransactionCategory = Transactioncategory::"Medical Claims" then
                       "Vendor Ledger Entry".SetFilter("Vendor Ledger Entry"."Is a Medical Claim",'%1',true);
                end;
            }
            ...
            begin
                ...
                if VendDateFilter <> '' then begin
                  ...
                  VendorLedgerEntry.SetFilter("Is a Medical Claim",'%1',true);
                  ...
                  "Detailed Vendor Ledg. Entry".SetFilter("Is a Medical Claim",'%1',true);
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(TransCatFilter;TransactionCategory)
                    {
                        ApplicationArea = Basic;
    ...
    begin
        ...
        with "Vendor Ledger Entry" do
          ...
          if TransactionCategory = Transactioncategory::" " then Error('Specify transaction Category!');
    end;
    ...
    var
        ...
        UnitsName: Text;
        Vend: Integer;
        TransactionCategory: Option " ",Normal,"Medical Claims";
