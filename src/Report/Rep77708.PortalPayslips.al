...
Report 77708 "Portal Payslips"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Portal Payslips.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61105;UnknownTable61105)
        {
            ...
            begin
                Clear(PeriodFilter);
                if "PRL-Salary Card".GetFilter("PRL-Salary Card"."Payroll Period")<>'' then
                  if Evaluate(PeriodFilter,("PRL-Salary Card".GetFilter("PRL-Salary Card"."Payroll Period"))) then begin
                    end;
