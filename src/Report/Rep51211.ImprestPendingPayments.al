...
Report 51211 "Imprest Pending Payments"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Imprest Pending Payments.rdlc';

    dataset
    {
        dataitem(UnknownTable61134;UnknownTable61134)
        {
            DataItemTableView = sorting(No) where(Status=const("2nd Approval"),"Payment Type"=const(Imprest),Posted=const(No));
            ...
            column(Imprest_Pending_PaymentsCaption;Imprest_Pending_PaymentsCaptionLbl)
            {
            }
    ...
    var
        Imprest_Pending_PaymentsCaptionLbl: label 'Imprest Pending Payments';
