...
Report 77736 "Stock Summary Clinic"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Stock Summary Clinic.rdlc';

    dataset
    {
        dataitem(Item;Item)
        {
            DataItemTableView = sorting("No.") where("Inventory Posting Group"=filter('MEDICAL'));
