...
Report 99908 "Monthly Meal-Proc. Analysis"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Monthly Meal-Proc. Analysis.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable99901;UnknownTable99901)
        {
            ...
            begin
                Clear(Monthz);
                if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=1 then Monthz:='JAN'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=2 then Monthz:='FEB'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=3 then Monthz:='MAR'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=4 then Monthz:='APR'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=5 then Monthz:='MAY'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=6 then Monthz:='JUN'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=7 then Monthz:='JUL'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=8 then Monthz:='AUG'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=9 then Monthz:='SEP'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=10 then Monthz:='OCT'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=11 then Monthz:='NOV'
                else if Date2dmy("Meal-Proc. Batch Lines"."Batch Date",2)=12 then Monthz:='DEC';
            end;
        }
    }
