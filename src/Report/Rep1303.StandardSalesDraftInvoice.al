...
Report 1303 "Standard Sales - Draft Invoice"
{
    ...
    WordLayout = './Layouts/Standard Sales - Draft Invoice.docx';
    ...
    dataset
    {
        dataitem(Header;"Sales Header")
        {
            ...
            dataitem(USReportTotalsLine;"Report Totals Buffer")
            {
                DataItemTableView = sorting("Line No.");
                UseTemporary = true;
                column(ReportForNavId_1020009; 1020009)
                {
                }
    ...
    local procedure GetTaxSummarizedLines(var TempSalesTaxAmountLine: Record UnknownRecord10011 temporary)
    var
        TaxArea: Record "Tax Area";
