...
Report 65577 "Sales By SalesPerson/Item"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales By SalesPersonItem.rdlc';
    ...
    dataset
    {
        dataitem(SalesHeader;"Sales Invoice Header")
        {
            ...
            RequestFilterFields = "User ID","Posting Date","Sell-to Customer No.","Posting Date","No.";
