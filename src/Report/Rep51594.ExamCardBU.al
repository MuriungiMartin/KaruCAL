...
Report 51594 "Exam Card BU"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exam Card BU.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            ...
            column(KARATINA_UNIVERSITY_EXAM_CARDCaption;KARATINA_UNIVERSITY_EXAM_CARDCaptionLbl)
            {
            }
    ...
    var
        ...
        KARATINA_UNIVERSITY_EXAM_CARDCaptionLbl: label 'KARATINA UNIVERSITY EXAM CARD';
