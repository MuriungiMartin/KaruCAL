...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Final Consolidate Marksheet 1.rdlc';

    dataset
    {
        dataitem(UnknownTable78007;UnknownTable78007)
        {
            RequestFilterFields = "Grad. Academic Year","Programme Code","Academic Year","Programme Option","Year of Study";
