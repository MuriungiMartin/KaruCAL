...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Certificate of Supply.rdlc';
    ...
    dataset
    {
        dataitem(CertificateOfSupply;"Certificate of Supply")
        {
            ...
            dataitem("Integer";"Integer")
            {
                ...
                column(DataItem22;Date_the_object_of_the_supply_was_received_in_the_Member_State_of_entry_if_the_supplying_trader_transported_or_dispatched_theLbl)
                {
                }
