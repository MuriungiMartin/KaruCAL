...
Report 78066 "Aca-Supp. Senate Summary"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(ExamCoregcs;UnknownTable66642)
        {
            DataItemTableView = where("Supp or Special Exists"=filter(Yes));
            ...
            dataitem(ExamStudUnits;UnknownTable66641)
            {
    ...
    var
        ...
        seqs: Integer;
        ExamCoregcsForNumber: Record UnknownRecord66642;
        AcaFinalConsMksCount: Record UnknownRecord77747;
        ACAProgrammeOptions: Record UnknownRecord61554;
        ACAResultsStatusez: Record UnknownRecord69266;
        YoSText: Text[1024];
        ...
        ACASenateReportCounts: Record UnknownRecord66646;
        ...
        ACAStudentUnits: Record UnknownRecord66641;
        CountedRecs: Integer;
        ...
        StudUnits: Record UnknownRecord66641;
        ExamsDone: Integer;
        FailCount: Integer;
        ...
        ResultsStatus: Record UnknownRecord69266;
        ResultsStatus3: Record UnknownRecord69266;
        ...
        ShowSem: Boolean;
        SemDesc: Code[100];
        CREG2: Record UnknownRecord66642;
        ...
        CurrNo: Integer;
        YoS: Code[20];
        CReg33: Record UnknownRecord66642;
        CReg: Record UnknownRecord66642;
        yosInt: Integer;
        IncVar1: Text[250];
        IncVar2: Text[250];
        IncVar3: Text[250];
