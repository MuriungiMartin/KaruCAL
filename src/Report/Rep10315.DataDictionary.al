...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Data Dictionary.rdlc';
    Caption = 'Data Dictionary';

    dataset
    {
        dataitem(TableDef;UnknownTable10040)
        {
            ...
            column(ReportForNavId_7728; 7728)
            {
            }
            ...
            dataitem(FieldDef;UnknownTable10040)
            {
                ...
                column(ReportForNavId_5183; 5183)
                {
                }
                ...
                dataitem(CaptionML;UnknownTable10040)
                {
                    ...
                    column(ReportForNavId_4876; 4876)
                    {
                    }
                ...
                dataitem(TableRelation;UnknownTable10040)
                {
                    DataItemLink = "Table No."=field("Table No."),"Field No."=field("Field No.");
            ...
            dataitem("Keys";UnknownTable10040)
            {
                ...
                dataitem(SumIndexFields;UnknownTable10040)
                {
                    ...
                    column(ReportForNavId_6650; 6650)
                    {
                    }
                ...
                trigger OnAfterGetRecord()
                var
                    DataDictionary: Record UnknownRecord10040;
                begin
            ...
            dataitem(NewPage;"Integer")
            {
                ...
                MaxIteration = 1;
                column(ReportForNavId_9087; 9087)
                {
                }
            }
    ...
    procedure GetFieldDef(var InputText: Text[1024];var InDataDictionary: Record UnknownRecord10040)
    begin
    ...
    procedure GetFieldProperties(var InputText: Text[1024];InDataDictionary: Record UnknownRecord10040)
    begin
    ...
    procedure ParseFieldType(var InDataDictionary: Record UnknownRecord10040)
    var
    ...
    procedure GetFieldClass(var InputText: Text[1024];var InDataDictionary: Record UnknownRecord10040)
    var
        Pos1: Integer;
        Pos2: Integer;
    begin
    ...
    procedure GetFieldDescription(var InputText: Text[1024];var InDataDictionary: Record UnknownRecord10040)
    var
        Pos1: Integer;
        Pos2: Integer;
    begin
    ...
    procedure GetFieldDecimalPlaces(var InputText: Text[1024];var InDataDictionary: Record UnknownRecord10040)
    var
        Pos1: Integer;
        Pos2: Integer;
    begin
    ...
    procedure GetKeyDef(var InputText: Text[1024];InDataDictionary: Record UnknownRecord10040)
    var
        Pos1: Integer;
        Pos2: Integer;
        KeyText: Text[1024];
    ...
    procedure GetKeyProperties(var InputText: Text[1024];InDataDictionary: Record UnknownRecord10040)
    begin
    ...
    procedure GetKeySumIndexFields(var InputText: Text[1024];InDataDictionary: Record UnknownRecord10040)
    var
        Pos1: Integer;
        Pos2: Integer;
    ...
    procedure GetKeyGroups(var InputText: Text[1024];InDataDictionary: Record UnknownRecord10040)
    var
        Pos1: Integer;
        Pos2: Integer;
    begin
    ...
    procedure MultipleLines(var InputText: Text[1024];var InDataDictionary: Record UnknownRecord10040;Delimiter: Text[30];Indent: Boolean)
    var
        ICount: Integer;
        EndOfText: Integer;
        Pos1: Integer;
