...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Document Entries.rdlc';
    ...
    dataset
    {
        dataitem("Integer";"Integer")
        {
            ...
            {
                DataItemTableView = sorting("Document No.","Posting Date");
                column(ReportForNavId_1020001; 1020001)
                {
                }
