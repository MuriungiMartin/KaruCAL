...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Post Inventory Cost to GL.rdlc';
    ...
    dataset
    {
        dataitem(PageLoop;"Integer")
        {
            ...
            dataitem(PerEntryLoop;"Integer")
            {
                ...
                column(ReportForNavId_8049; 8049)
                {
                }
                ...
                dataitem(CapValueEntryLoop;"Integer")
                {
                    ...
                    column(ReportForNavId_1181; 1181)
                    {
                    }
            ...
            dataitem(InvtPostingBufferLoop;"Integer")
            {
                ...
                column(ReportForNavId_7781; 7781)
                {
                }
                ...
                begin
                    ...
                    InvtPost.GetDimBuf(InvtPostBuf."Dimension Set ID",TempDimBuf);
                    GetDimText;
            ...
            dataitem(SkippedValueEntry;"Value Entry")
            {
                ...
                column(ReportForNavId_7523; 7523)
                {
                }
