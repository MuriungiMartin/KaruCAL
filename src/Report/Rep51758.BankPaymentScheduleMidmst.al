...
Report 51758 "Bank Payment Schedule-Mid mst"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Bank Payment Schedule-Mid mst.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61077;UnknownTable61077)
        {
            ...
            dataitem(UnknownTable61118;UnknownTable61118)
            {
                ...
                RequestFilterFields = "Current Month Filter","Location/Division Code","Transaction Code Filter","Department Code","Cost Center Code","Salary Grade","Salary Notch/Step";
                ...
                column(TransAmount;"HR-Employee"."Transaction Amount")
                {
                }
                column(TransAmountUtil;"HR-Employee"."Transaction AUtil")
                {
                }
                column(TransAmountEdu;"HR-Employee"."Transaction AEdu")
                {
                }
                column(TransAmountFurn;"HR-Employee"."Transaction AFurn")
                {
                }
                ...
                begin
                    ...
                    if "HR-Employee"."Transaction Amount" = 0 then
                    CurrReport.Skip;
                    ...
                    GrandTotal:=GrandTotal+"HR-Employee"."Transaction Amount";
                ...
                begin
                    ...
                    */
                    ...
                    if "HR-Employee".GetFilter("HR-Employee"."Transaction Code Filter") = '' then
                    Error('You must specify the transaction filter.');
