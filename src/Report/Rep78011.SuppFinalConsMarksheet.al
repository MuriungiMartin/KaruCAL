...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Supp. Final Cons. Marksheet.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            ...
            column(YearlyCurrAverage;"ACA-Course Registration"."Supp. Yearly Curr. Average")
            {
            }
            ...
            dataitem(UnknownTable61549;UnknownTable61549)
            {
                ...
                begin
                    ...
                    units_Subjects.SetFilter(Desription,'<>%1','');
                    ...
                    //ELSE
                     // "ACA-Student Units".CALCFIELDS("ACA-Student Units"."Supp. Total Score");
                      if (("ACA-Course Registration"."Supp. Yearly Remarks"='EXPELLED') or
                       ...
                       if "ACA-Student Units"."Special Exam"="ACA-Student Units"."special exam"::Special then  SuppExists:=true;
                     //  IF SuppExists THEN GenCourseSuppExists:=SuppExists;
                end;
            }
            ...
            begin
                ...
                "ACA-Course Registration".CalcFields("ACA-Course Registration"."Supplementary Exists","ACA-Course Registration"."Special Exam Exists");
