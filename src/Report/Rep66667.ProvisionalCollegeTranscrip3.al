...
Report 66667 "Provisional College Transcrip3"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Provisional College Transcrip3.rdlc';
    Caption = 'Provisional College Transcript';

    dataset
    {
        dataitem(CourseRegs;UnknownTable66651)
        {
            ...
            dataitem(StudUnitsss;UnknownTable66650)
            {
                ...
                DataItemTableView = where("Is a Resit/Repeat"=filter(No));
                ...
                dataitem(ExamGraddingSetup;UnknownTable61599)
                {
                    DataItemLink = Category=field("Exam Category"),Grade=field(Grade);
                    DataItemTableView = where("Hide in Summary"=filter(No));
            ...
            begin
                ...
                Clear(CourseReg12);
                CourseReg12.Reset;
                CourseReg12.SetRange(Programme,CourseRegs.Programme);
    ...
    var
        ACASuppExamClassUnits777: Record UnknownRecord66641;
        ACA2ndSuppExamCoReg777: Record UnknownRecord66682;
        ACASuppExamCoReg777: Record UnknownRecord66642;
        SuppExists: Boolean;
        SuppExamCoRegs: Record UnknownRecord66642;
        SuppExamUnits: Record UnknownRecord66641;
        SecondSuppCoreg: Record UnknownRecord66682;
        SecondSupUnits: Record UnknownRecord66681;
        remsz: Text[250];
        ProvisionalTranscriptComment: Record UnknownRecord88852;
