...
Report 99956 "Norminal Roll (Enrol Students)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Norminal Roll (Enrol Students).rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            ...
            column(stoppagereason;courseRegst."Stoppage Reason")
            {
            }
            column(settle_type;courseRegst."Settlement Type")
            {
            }
