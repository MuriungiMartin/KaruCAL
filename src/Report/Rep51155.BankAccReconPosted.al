...
Report 51155 "Bank Acc. Recon. - Posted"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Bank Acc. Recon. - Posted.rdlc';
    ...
    dataset
    {
        dataitem("Bank Account Statement Line";"Bank Account Statement Line")
        {
            ...
            column(Bank_Account_Statement_Line__Bank_Account_No__;"Bank Account No.")
            {
            }
            ...
            column(BankStatBalance_TotalUnpresentedChqs_UncreditedChqs;BankStatBalance+TotalUnpresentedChqs-UncreditedChqs)
            {
            }
            column(BankStatBalance_Control1102760006;BankStatBalance)
            {
            }
            ...
            column(Bank_Account_Statement_Line__Applied_Amount_;"Applied Amount")
            {
            }
            ...
            column(Bank_Account_Statement_Line_Difference;Difference)
            {
            }
            ...
            column(Expected_Balance_As_Per_Bank_StatementCaption;Expected_Balance_As_Per_Bank_StatementCaptionLbl)
            {
            }
            column(Actual_Balance_on_Bank_Statement_Caption;Actual_Balance_on_Bank_Statement_CaptionLbl)
            {
            }
            ...
            column(Bank_Account_Statement_Line__Document_No__Caption;FieldCaption("Document No."))
            {
            }
            column(DateCaption;DateCaptionLbl)
            {
            }
            column(Bank_Account_Statement_Line_DescriptionCaption;FieldCaption(Description))
            {
            }
            ...
            column(Bank_Account_Statement_Line_DifferenceCaption;FieldCaption(Difference))
            {
            }
            ...
            column(Difference_between_Cashbook_and_BankCaption;Difference_between_Cashbook_and_BankCaptionLbl)
            {
            }
            column(DataItem50;Prepared_by______________________________________________________________Date_______________________________________________CLbl)
            {
            }
            column(DataItem51;Reviewed_by______________________________________________________________Date_______________________________________________CLbl)
            {
            }
            column(DataItem52;Approved_by______________________________________________________________Date_______________________________________________CLbl)
            {
            }
            ...
            column(AccountName_BankAccountStatementLine;'xxxxxxxxxxxxxxxx')
            {
            }

            trigger OnAfterGetRecord()
            begin
                if "Bank Account Statement Line".Reconciled=false then
                begin
                if "Bank Account Statement Line"."Applied Amount">0 then
                UncreditedChqs:=UncreditedChqs+"Bank Account Statement Line"."Applied Amount"
                else
                TotalUnpresentedChqs:=TotalUnpresentedChqs+"Bank Account Statement Line"."Applied Amount";
                end;

                //"Bank Account Statement Line".CALCFIELDS(Bank);
            end;
    ...
    var
        ...
        Expected_Balance_As_Per_Bank_StatementCaptionLbl: label 'Expected Balance As Per Bank Statement';
        Actual_Balance_on_Bank_Statement_CaptionLbl: label 'Actual Balance on Bank Statement:';
        ...
        Difference_between_Cashbook_and_BankCaptionLbl: label 'Difference between Cashbook and Bank';
