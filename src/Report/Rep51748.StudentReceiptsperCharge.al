...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Student Receipts per Charge.rdlc';
                    ...
                    dataitem(UnknownTable61532;UnknownTable61532)
                    {
                        ...
                        dataitem("Cust. Ledger Entry";"Cust. Ledger Entry")
                        {
                            ...
                            dataitem("Detailed Cust. Ledg. Entry";"Detailed Cust. Ledg. Entry")
                            {
                                ...
                                column(postDate;"Detailed Cust. Ledg. Entry"."Posting Date")
                                {
                                }

                                trigger OnAfterGetRecord()
                                begin
                                        // CurrReport.SHOWOUTPUT(COPYSTR("Detailed Cust. Ledg. Entry"."Document No.",1,3)='RCT')
                                        if (CopyStr("Detailed Cust. Ledg. Entry"."Document No.",1,3)<>'RCT') then CurrReport.Skip;
                                end;

                                trigger OnPreDataItem()
                                begin
                                         "Detailed Cust. Ledg. Entry".SetFilter("Detailed Cust. Ledg. Entry"."Posting Date",'%1..%2',startDate,endDate);
                                end;
                            }
                            ...
                            begin
                                ...
                                detcust.Reset;
                                detcust.SetRange(detcust."Entry Type",detcust."entry type"::Application);
                                detcust.SetRange(detcust."Cust. Ledger Entry No.","Cust. Ledger Entry"."Entry No.");
                                detcust.SetFilter(detcust."Posting Date",'%1..%2',startDate,endDate);
