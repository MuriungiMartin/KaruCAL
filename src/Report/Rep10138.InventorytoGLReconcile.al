...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Inventory to GL Reconcile.rdlc';
    ...
    var
        ...
        TempBuffer: Record UnknownRecord10139 temporary;
        ItemFilter: Text;
    ...
    var
        AlreadyInsertedTempBuffer: Record UnknownRecord10139 temporary;
    begin
