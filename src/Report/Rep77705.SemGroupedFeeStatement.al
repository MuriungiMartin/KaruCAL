...
Report 77705 "Sem. Grouped Fee Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sem. Grouped Fee Statement.rdlc';
        ...
        dataitem(Customer;Customer)
        {
            ...
            dataitem("Cust. Ledger Entry";"Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    Clear(Semz);
                    ACASemesters.Reset;
                    ACASemesters.SetFilter(From,'=%1|<%2',"Cust. Ledger Entry"."Posting Date","Cust. Ledger Entry"."Posting Date");
                    ACASemesters.SetFilter(ACASemesters."To",'=%1|>%2',"Cust. Ledger Entry"."Posting Date","Cust. Ledger Entry"."Posting Date");
