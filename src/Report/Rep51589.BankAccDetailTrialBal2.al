...
Report 51589 "Bank Acc. - Detail Trial Bal.2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Bank Acc. - Detail Trial Bal.2.rdlc';
    ...
    dataset
    {
        dataitem("Bank Account";"Bank Account")
        {
            ...
            column(Cash_Book_Caption;Cash_Book_CaptionLbl)
            {
            }
            ...
            dataitem("Bank Account Ledger Entry";"Bank Account Ledger Entry")
            {
                ...
                begin
                    ...
                    Credit:=Credit+"Bank Account Ledger Entry"."Credit Amount (LCY)";
                    Debit:=Debit+"Bank Account Ledger Entry"."Debit Amount (LCY)";
                end;
            ...
            begin
                ...
                "Bank Account Ledger Entry"."Amount (LCY)",StartBalanceLCY);
            end;
        }
    }
    ...
    var
        ...
        Credit: Decimal;
        Debit: Decimal;
        Cash_Book_CaptionLbl: label 'Cash Book ';
