...
Report 51293 "Interbank Details"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(UnknownTable61500;UnknownTable61500)
        {
            ...
            column(ExternalDocNo;"FIN-InterBank Transfers"."External Doc No.")
            {
            }
            ...
            column(CreatedBy_InterBankTransfers;"FIN-InterBank Transfers"."Created By")
            {
            }
