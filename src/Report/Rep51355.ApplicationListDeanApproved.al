...
Report 51355 "Application List Dean Approved"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Dean Approved.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const("Dean Approved"));
