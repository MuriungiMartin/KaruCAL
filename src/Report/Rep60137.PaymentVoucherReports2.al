...
Report 60137 "Payment Voucher Reports 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Payment Voucher Reports 2.rdlc';

    dataset
    {
        dataitem(UnknownTable60200;UnknownTable60200)
        {
            ...
            dataitem("<Payment Line>";UnknownTable60235)
            {
            ...
            dataitem(Summary;UnknownTable60235)
            {
                DataItemLink = No=field("No.");
                DataItemTableView = sorting("Line No.",No,Type) order(ascending);
            ...
            dataitem(UnknownTable60260;UnknownTable60260)
            {
    ...
    var
        ...
        payTypes: Record "ACA-Std Disciplinary Details";
        vends: Record Vendor;
}
