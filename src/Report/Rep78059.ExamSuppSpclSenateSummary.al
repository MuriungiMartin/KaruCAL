...
Report 78059 "Exam Supp/Spcl Senate Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Exam SuppSpcl Senate Summary.rdlc';
            ...
            dataitem(ExamsCoreg;UnknownTable66651)
            {
                ...
                dataitem(ExamClassUnits;UnknownTable66650)
                {
                    ...
                    begin
                        ...
                        ACASuppExamClassUnits.SetRange("Student No.",);
                        ACASuppExamClassUnits.SetRange("Unit Code",);
                        ACASuppExamClassUnits.SetRange("Academic Year",);
                        ACASuppExamClassUnits.SetRange("Year of Study",);
                ...
                begin
                    ...
                    if ExamsCoreg."Programme Option"<>'' then begin
                      ...
                      ACASuppExamCoReg.SetRange("Student Number",ExamsCoreg."Student Number");
                      ACASuppExamCoReg.SetRange("Year of Study",ExamsCoreg."Year of Study");
                      ACASuppExamCoReg.SetRange("Academic Year",ExamsCoreg."Academic Year");
                      ACASuppExamCoReg.SetRange("Reporting Academic Year",ExamsCoreg."Reporting Academic Year");
                      if ACASuppExamCoReg.Find('-') then begin
                        ExamsCoreg."Category Order":=ACASuppExamCoReg."Category Order";
                        ExamsCoreg."Rubric Number":=ACASuppExamCoReg."Rubric Number";
                        ExamsCoreg.Classification:=ACASuppExamCoReg.Classification;
                        ExamsCoreg."Final Classification Pass":=ACASuppExamCoReg."Final Classification Pass";
                        ExamsCoreg.Graduating:=ACASuppExamCoReg.Graduating;
                        end;
