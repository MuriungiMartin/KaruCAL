...
Report 99258 "13thSlip- Payslip (Horizontal)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/13thSlip- Payslip (Horizontal).rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable99200;UnknownTable99200)
        {
            ...
            column(payPoint;'MUKURWEINI DAIRY')
            {
            }
            ...
            begin
                ...
                datesfil:=Format("PRl 13thSlip DaysComp"."Payroll Period")+'..'+Format(CalcDate('<+1M-1D>',"PRl 13thSlip DaysComp"."Payroll Period"));
                dates1.Reset;
                ...
                dates1.SetFilter(dates1."Period Start",'%1..%2',"PRl 13thSlip DaysComp"."Payroll Period",CalcDate('<+1M-1D>',"PRl 13thSlip DaysComp"."Payroll Period"));
                ...
                *****************************************************************************************************/
                ...
                //BEGIN
                  //CLEAR(objOcx);
                  strEmpCode:="PRl 13thSlip DaysComp"."Employee Code";
    ...
    begin
        ...
        //"PRL-Salary Card".SETFILTER("PRl 13thSlip DaysComp"."Payroll Period",'=%1',PeriodFilter);
    end;
