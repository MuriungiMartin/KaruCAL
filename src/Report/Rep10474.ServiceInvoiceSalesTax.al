...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Service Invoice-Sales Tax.rdlc';
        ...
        dataitem("Service Invoice Header";"Service Invoice Header")
        {
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    {
                        DataItemTableView = sorting(Number);
                        column(ReportForNavId_5141; 5141)
                        {
                        }
                        ...
                        trigger OnPreDataItem()
                        begin
                            CurrReport.CreateTotals(TaxLiable,AmountExclInvDisc,TempServInvoiceLine.Amount,TempServInvoiceLine."Amount Including VAT");
