...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Approval User Setup Test.rdlc';
    ...
    dataset
    {
        dataitem("Integer";"Integer")
        {
            ...
            dataitem("Sales Approval";"User Setup")
            {
                ...
                column(ReportForNavId_1465; 1465)
                {
                }
            ...
            {
                DataItemTableView = sorting("User ID");
                column(ReportForNavId_9569; 9569)
                {
                }
            ...
            {
                DataItemTableView = sorting("User ID");
                column(ReportForNavId_7013; 7013)
                {
                }
    ...
    var
        ...
        Text004: label '%1 Approval Setup appears to be OK.';
        UserCode: Code[50];
    ...
    procedure MakeStatusText(ApprovalCaption: Text[250]): Text[250]
    begin
