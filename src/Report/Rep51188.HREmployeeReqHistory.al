...
Report 51188 "HR Employee Req History"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HR Employee Req History.rdlc';
        ...
        dataitem(UnknownTable61188;UnknownTable61188)
        {
            ...
            dataitem(UnknownTable61214;UnknownTable61214)
            {
                ...
                dataitem(UnknownTable61255;UnknownTable61255)
                {
                    ...
                    DataItemLinkReference = "HRM-Job Interview";
                    column(ReportForNavId_1102755046; 1102755046)
                    {
                    }
                    column(HR_Job_Interview_Interview_Code;"HRM-Job Interview"."Interview Code")
                    {
                    }
                    column(HR_Job_Interview_Interview_Description;"HRM-Job Interview"."Interview Description")
                    {
                    }
                    column(HR_Job_Interview_Score;"HRM-Job Interview".Score)
                    {
                    }
                    column(HR_Job_Interview_Interviewer_Name;"HRM-Job Interview"."Interviewer Name")
                    {
                    }
                    column(HR_Job_Interview_comments;"HRM-Job Interview".comments)
                    {
                    }
                }
            }
