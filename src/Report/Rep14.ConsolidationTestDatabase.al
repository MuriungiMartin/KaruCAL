...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Consolidation - Test Database.rdlc';
    ...
    dataset
    {
        dataitem("Business Unit";"Business Unit")
        {
            ...
            dataitem(Header;"Integer")
            {
                ...
                {
                    DataItemTableView = sorting(Number) where(Number=const(1));
                    column(ReportForNavId_6675; 6675)
                    {
                    }
                ...
                group(Options)
                {
                    ...
                    group("Copy Field Contents")
                    {
                        ...
                        field(CopyDimensions;ColumnDim)
                        {
                            ...
                            Editable = false;
                            ToolTip = 'Specifies dimensions, which be copied.';
    ...
    begin
        ...
        if "G/L Account"."Consol. Debit Acc." <> '' then
        ...
        if "G/L Account"."Consol. Debit Acc." = "G/L Account"."Consol. Credit Acc." then
          exit;
        if "G/L Account"."Consol. Credit Acc." <> '' then
