...
Report 69304 "All Students Reg"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/All Students Reg.rdlc';

    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            DataItemTableView = sorting(Programme,Stage) where(Reversed=filter(No),"Cust Exist"=filter(>0));
            ...
            column(Balance;Cust."Credit Amount")
            {
            }
