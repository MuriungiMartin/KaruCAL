...
Report 51281 "Receipt Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Receipt Report.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61157;UnknownTable61157)
        {
            ...
            column(Cash_Sale_Header__Cashier_Bank_;"Cashier Bank")
            {
            }
            ...
            column(Cash_Sale_Header__Posted_Date_;"Posted Date")
            {
            }
            ...
            column(Cash_Sale_Header__Cashier_Bank_Caption;FieldCaption("Cashier Bank"))
            {
            }
            ...
            column(Cash_Sale_Header__Posted_Date_Caption;FieldCaption("Posted Date"))
            {
            }
