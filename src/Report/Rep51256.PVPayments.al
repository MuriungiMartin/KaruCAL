...
Report 51256 "PV Payments"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PV Payments.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61134;UnknownTable61134)
        {
            ...
            column(PV_Payments_RegisterCaption;PV_Payments_RegisterCaptionLbl)
            {
            }
            ...
            begin
                   "FIN-Payments".SetRange("FIN-Payments"."Payment Type","FIN-Payments"."payment type"::Normal);
    ...
    var
        ...
        PV_Payments_RegisterCaptionLbl: label 'PV Payments Register';
