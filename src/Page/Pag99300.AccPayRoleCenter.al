...
Page 99300 "Acc. & Pay Role Center"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ...
    actions
    {
        area(reporting)
        {
            group(SalesAnalysisReports)
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Detailed Customer Invoices';
                    Image = CustomerLedger;
                    Promoted = true;
                    PromotedIsBig = true;
                    RunObject = Report "Det. Invoices (Customer&Inv.)";
                }
            }
            group(Vendor)
            {
        ...
        area(sections)
        {
            ...
            group("13thSlips")
            {
                Caption = '13thSlips Payroll';
                action("<Page 99200>")
                {
                    ApplicationArea = Basic,Suite;
                    Caption = '13thSlip Employee List';
                    RunObject = Page "HRM-13thSlip Pay List";
                ...
                action("<Page 99202>")
                {
                    ApplicationArea = Basic,Suite;
                    Caption = 'Worked Days';
                    RunObject = Page "PRL-13thSlip Worked Days";
                    ToolTip = 'Set up the chart of cash flow accounts.';
                }
                action("<Page 99203>")
                {
                    ApplicationArea = Basic,Suite;
                    Caption = '13thSlip Payroll Periods';
                    RunObject = Page "PRL-13thSlip Payroll Periods";
            ...
            group("Cash Management")
            {
                ...
                action("Buffer Receipts")
                {
                    ApplicationArea = Basic;
                    Caption = 'Buffer Receipts';
            ...
            group(Attnd)
            {
                ...
                Image = Statistics;
                action("13thSlipStaffCurr")
                {
                    ApplicationArea = Basic;
                    Caption = '13thSlip Staff  Present';
                    Image = Purchasing;
                    Promoted = true;
                    PromotedIsBig = true;
                    RunObject = Page "13thSlip Attendance (Current)";
                    ToolTip = 'Open Attendance List for 13thSlip Employees';
                }
                action("13thSlipStaff")
                {
                    ApplicationArea = Basic;
                    Caption = '13thSlip Staff Attendance List';
                    Image = Purchasing;
                    Promoted = true;
                    PromotedIsBig = true;
                    RunObject = Page "13thSlip Staff Attendance View";
                    ToolTip = 'Open Attendance List for 13thSlip Employees';
                }
            }
            group(Approvals)
