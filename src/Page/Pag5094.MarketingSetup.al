        ...
        area(content)
        {
            ...
            group(Defaults)
            {
                ...
                group(Default)
                {
                    ...
                    field("Default Correspondence Type";"Default Correspondence Type")
                    {
                        ...
                        ToolTip = 'Specifies the correspondence type to assign automatically to contacts when they are created.';
                    }
                    ...
                    field("Default To-do Date Calculation";"Default To-do Date Calculation")
                    {
                        ...
                        ToolTip = 'Specifies the to-do date calculation formula to use to calculate the ending date for to-dos in Microsoft Dynamics NAV if you haven''t entered any due date in the Outlook task. If you leave the field blank, today''s date is applied.';
                    }
                }
            }
            group(Interactions)
            ...
            group(Synchronization)
            {
                ...
                field(EnableSynchronization;GlobalSynchronizationIsEnabled)
                {
                    ...
                    ToolTip = 'Specifies whether to synchronize the contact card with the customer, vendor, and bank account.';
            ...
            group(Numbering)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the code for the number series to use when assigning numbers to to-dos.';
                }
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Generate Integration IDs for Connector for Microsoft Dynamics")
                {
                    ...
                    ToolTip = 'Generate identifiers (GUID) for records that can be used by Microsoft Dynamics CRM and in Microsoft Dynamics NAV.';
