        ...
        area(content)
        {
            group(General)
            {
                ...
                field(GLPrice;GainLoss)
                {
                    ...
                    AutoFormatType = 1;
                    Caption = 'Gain/Loss';
                    ToolTip = 'Specifies the total gain (credit) or loss (debit) for the fixed asset as a FlowField. The field is calculated using the entries in the FA Ledger Entries window. To see the ledger entries that make up the amount shown, click the field.';
                ...
                fixed(Control1903895301)
                {
                    group("Last FA Posting Date")
                    {
                        ...
                        field(LastWriteDown;LastWriteDown)
                        {
                            ApplicationArea = FixedAssets;
                            Caption = 'Write-Down';
                            ToolTip = 'Specifies the total $ amount of write-down entries for the fixed asset.';
                        }
                        ...
                        field(LastCustom1;LastCustom1)
                        {
                            ApplicationArea = FixedAssets;
                            Caption = 'Custom 1';
                            ToolTip = 'Specifies the total $ amount for custom 1 entries for the fixed asset.';
                        }
                        ...
                        field(LastCustom2;LastCustom2)
                        {
                            ApplicationArea = FixedAssets;
                            Caption = 'Custom 2';
                            ToolTip = 'Specifies the total $ amount for custom 2 entries for the fixed asset.';
                        }
