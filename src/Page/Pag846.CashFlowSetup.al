    ...
    layout
    {
        area(content)
        {
            ...
            group("Cortana Intelligence")
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the number of seconds to wait before canceling the call to AzureML.';
                }
                ...
                field("Total Proc. Time";Format(AzureMachineLearningUsage.GetTotalProcessingTime))
                {
                    ApplicationArea = Basic,Suite;
        ...
        area(processing)
        {
            group("Chart Options")
            {
                ...
                action("Open Cortana Intelligence Gallery")
                {
                    ...
                    Image = LinkWeb;
                    Promoted = true;
                    ToolTip = 'Explore models for Azure Machine Learning, and use Azure Machine Learning Studio to build, test, and deploy the Forecasting Model for Microsoft Dynamics 365 for Financials.';
