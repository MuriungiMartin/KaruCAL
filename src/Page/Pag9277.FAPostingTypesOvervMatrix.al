...
Page 9277 "FA Posting Types Overv. Matrix"
{
        ...
        area(content)
        {
            repeater(Control1)
            {
                field("FA No.";"FA No.")
                {
                    ...
                    ToolTip = 'Specifies a fixed asset that you have set up.';
                }
    ...
    procedure Load(MatrixColumns1: array [32] of Text[1024];var MatrixRecords1: array [32] of Record "FA Matrix Posting Type";CurrentNoOfMatrixColumns: Integer;DateFilterLocal: Text[250];RoundingFactorLocal: Option "None","1","1000","1000000")
    var
        i: Integer;
    begin
