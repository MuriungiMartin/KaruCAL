    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the ID of the Microsoft Dynamics NAV user who is responsible for the configuration worksheet.';
                }
                field(Status;Status)
                {
                    ApplicationArea = Basic,Suite;
                ...
                field("Page ID";"Page ID")
                {
                    ...
                    AssistEdit = true;
                    BlankZero = true;
                    ToolTip = 'Specifies the number of the page that is associated with the table that is specified on the configuration worksheet.';
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the name of the page that is associated with the table specified on the configuration worksheet.';
                }
        ...
        area(factboxes)
        {
            part(Control6;"Config. Package Table FactBox")
            {
                ApplicationArea = Basic,Suite;
            ...
            part(Control28;"Config. Related Tables FactBox")
            {
                ApplicationArea = Basic,Suite;
        ...
        area(processing)
        {
            ...
            group(Excel)
            {
                ...
                action("Export to Template")
                {
                    ...
                    PromotedIsBig = true;
                    ToolTip = 'Export the data to an Excel workbook to serve as a template that is based on the structure of an existing database table quickly. You can then use the template to gather together customer data in a consistent format for later import into Dynamics NAV.';
