    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the number of the blanket order that the purchase invoice originates from.';
                    Visible = false;
                }
                field("Blanket Order Line No.";"Blanket Order Line No.")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the number of the blanket order line that the purchase invoice line originates from.';
                    Visible = false;
                }
