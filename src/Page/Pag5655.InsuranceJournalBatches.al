    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the number series code that will assign document numbers to journal lines in this journal batch.';
                }
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies which reason code is linked to the journal batch.';
                    Visible = true;
                }
            }
        }
