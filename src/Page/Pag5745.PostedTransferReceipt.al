        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Transfer Order No.";"Transfer Order No.")
                {
                    ...
                    Importance = Promoted;
                    Lookup = false;
                    ToolTip = 'Specifies the number of the transfer order on which the transfer receipt was based.';
                }
                field("Transfer Order Date";"Transfer Order Date")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the date you created the transfer order.';
                }
            ...
            group("Transfer-from")
            {
                ...
                field("Shipping Agent Service Code";"Shipping Agent Service Code")
                {
                    ...
                    Editable = false;
                    Importance = Promoted;
                    ToolTip = 'Specifies the code for the shipping agent service that applies to the transfer shipment received at the transfer-to location.';
                }
            }
            group("Transfer-to")
            {
                ...
                field("Transfer-to Address 2";"Transfer-to Address 2")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies an additional part of the address of the location that you are transferring items to.';
                }
