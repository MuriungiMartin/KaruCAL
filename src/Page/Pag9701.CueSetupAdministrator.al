...
Page 9701 "Cue Setup Administrator"
{
    ...
    Caption = 'Cue Setup Administrator';
    PageType = List;
        ...
        area(content)
        {
            repeater(Group)
            {
                field("User Name";"User Name")
                {
                    ...
                    ToolTip = 'Specifies which Microsoft Dynamics NAV user the indicator setup for the Cue pertains to. If you leave this field blank, then the indicator setup will pertain to all users.';
                }
                field("Table ID";"Table ID")
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the ID of the Microsoft Dynamics NAV table that contains the Cue.';
                }
