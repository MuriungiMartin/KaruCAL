    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies additional attributes that are used to create the cashflow statement.';
                }
        ...
        area(factboxes)
        {
            part(Control11;"G/L Accounts ListPart")
            {
                ApplicationArea = Basic,Suite;
                Caption = 'G/L Accounts in Category';
                Editable = false;
            ...
            part(Control12;"G/L Accounts ListPart")
            {
                ApplicationArea = Basic,Suite;
