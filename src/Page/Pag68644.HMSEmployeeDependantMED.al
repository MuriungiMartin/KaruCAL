...
Page 68644 "HMS Employee Dependant MED"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control1102760000;"HMS Employee Dependant SUB")
            {
                ...
                SubPageView = where("Patient Type"=const(Employee),"Request Registration"=const(true),Blocked=const(true),Status=const("HOD HR Approved"));
            }
        }
    }
