    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies a number for the account schedule column.';
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the column type for the account schedule column.';
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies a period formula that specifies the accounting periods that you want to use to calculate the amount in this column.';
                    Visible = false;
                }
                field(Show;Show)
                {
