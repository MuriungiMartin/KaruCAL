...
Page 68496 "ACA-Admission Form Header"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            group("Documents Verification")
            {
                ...
                field("Documents Verified By";"Documents Verified By")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                }
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action("Acceptance & Correspondance")
            {
                ApplicationArea = Basic;
                Image = Addresses;
                Promoted = true;
                ...
                RunPageLink = "No."=field("Admission No.");
            }
            action(Photo)
            {
                ApplicationArea = Basic;
                ...
                Promoted = true;
                PromotedIsBig = true;
                RunObject = Page "Student Portal Def/Withdrawal";
                RunPageLink = "Document Type"=field("Admission No.");
            }
        }
    }
