        ...
        area(content)
        {
            ...
            repeater(Group)
            {
                ...
                field("External Document No.";"External Document No.")
                {
                    ApplicationArea = Basic,Suite;
                    Editable = false;
                    ToolTip = 'Specifies the external document number of the posted purchase and sales document that does not have an incoming document record.';
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the debit amount of the entry on the posted purchase and sales document that does not have an incoming document record.';
                }
                field("Credit Amount";"Credit Amount")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the amount of the credit entry on the posted purchase and sales document that does not have an incoming document record.';
                    Visible = false;
                }
            }
        }
