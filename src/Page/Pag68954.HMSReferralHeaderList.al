...
Page 68954 "HMS-Referral Header List"
{
            ...
            group("&Functions")
            {
                ...
                action("Referral Form")
                {
                    ...
                    begin
                        ...
                        HMSReferralHeader.SetFilter(HMSReferralHeader."Patient No.","Patient No.");
                        if HMSReferralHeader.FindFirst then begin
                        Report.Run(51871,true);
                        end
                    end;
                }
            }
