    ...
    layout
    {
        area(content)
        {
            field(CurrentJnlBatchName;CurrentJnlBatchName)
            {
                ...
                Caption = 'Batch Name';
                Lookup = true;
                ToolTip = 'Specifies the batch name on the sales journal.';
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the customer''s product type to link transactions made for this customer with the appropriate general ledger account according to the general posting setup.';
                }
