...
Page 5540 "Item Availability by Timeline"
{
        ...
        area(content)
        {
            group(Options)
            {
                ...
                field("<VariantFilter>";VariantFilter)
                {
                    ...
                    Importance = Promoted;
                    ToolTip = 'Specifies a variant code to view only the projected inventory for that variant of the item.';
                ...
                field("<LocationFilter>";LocationFilter)
                {
                    ...
                    Importance = Promoted;
                    ToolTip = 'Specifies a location code to view only the projected inventory for the item at that location.';
                ...
                field("<ForecastName>";ForecastName)
                {
                    ...
                    ToolTip = 'Specifies a production forecast you want to include as anticipated demand in the graphical view of projected inventory.';
                ...
                field("<IncludeBlanketOrders>";IncludeBlanketOrders)
                {
                    ...
                    Importance = Promoted;
                    ToolTip = 'Specifies if you want to include anticipated demand from blanket sales orders in the graphical view of projected inventory.';
    ...
    var
        ...
        Text004: label 'Show Projected Inventory';
