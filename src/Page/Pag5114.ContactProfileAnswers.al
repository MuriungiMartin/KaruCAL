...
Page 5114 "Contact Profile Answers"
{
    ...
    procedure SetParameters(var SetCont: Record Contact;SetProfileQuestionnaireCode: Code[10];SetContProfileAnswerCode: Code[10];SetContProfileAnswerLine: Integer)
    begin
        Cont := SetCont;
    ...
    procedure SetRunFromForm(var ProfileQuestionnaireLine: Record "Profile Questionnaire Line";ContactFrom: Record Contact;CurrQuestionsChecklistCodeFrom: Code[10])
    begin
        Set := true;
        RunFormCode := true;
        Cont := ContactFrom;
