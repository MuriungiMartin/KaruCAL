        ...
        area(content)
        {
            ...
            group(Shipping)
            {
                ...
                field("Ship-to Post Code";"Ship-to Post Code")
                {
                    ...
                    ToolTip = 'Specifies the ZIP code at the address that the items were shipped to.';
                }
                ...
                field("Package Tracking No.";"Package Tracking No.")
                {
                    ...
                    ToolTip = 'Specifies the shipping agent''s package number and is used for tracking.';
                }
