...
Page 78073 "ACA-My Approved for Post"
{
    ...
    begin
        ...
        if Rec.Status = Rec.Status::Approved then begin
          ShowPostButton := true
          end else ShowPostButton := false;
    end;

    trigger OnOpenPage()
    begin
        Clear(ShowPostButton);
    end;
    ...
    var
        ...
        ACAResultsApprovalEntries2: Record UnknownRecord78063;
}
