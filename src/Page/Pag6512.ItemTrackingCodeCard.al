            ...
            group("Serial No.")
            {
                ...
                group(Inbound)
                {
                    ...
                    field("SN Assembly Inbound Tracking";"SN Assembly Inbound Tracking")
                    {
                        ...
                        ToolTip = 'Indicates that serial numbers are required with inbound posting from assembly orders.';
                    }
                ...
                group(Outbound)
                {
                    ...
                    field("SN Assembly Outbound Tracking";"SN Assembly Outbound Tracking")
                    {
                        ApplicationArea = Basic;
                        Caption = 'SN Assembly Tracking';
                        ToolTip = 'Indicates that serial numbers are required with outbound posting from assembly orders.';
                    }
            ...
            group("Lot No.")
            {
                ...
                group(Control47)
                {
                    ...
                    field("Lot Assembly Inbound Tracking";"Lot Assembly Inbound Tracking")
                    {
                        ...
                        ToolTip = 'Indicates that lot numbers are required with inbound posting from assembly orders.';
                    }
                ...
                group(Control48)
                {
                    ...
                    field("Lot Assembly Outbound Tracking";"Lot Assembly Outbound Tracking")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Lot Assembly Tracking';
                        ToolTip = 'Indicates that lot numbers are required with outbound posting from assembly orders.';
                    }
