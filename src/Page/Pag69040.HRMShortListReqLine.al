...
Page 69040 "HRM-ShortList Req. Line"
{
    CardPageID = "HRM-ShortList Req. Card";
    PageType = List;
    SourceTable = UnknownTable61210;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("ShortList Code";"ShortList Code")
                {
                    ApplicationArea = Basic;
                }
