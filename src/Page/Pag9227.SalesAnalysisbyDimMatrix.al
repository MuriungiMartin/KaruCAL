...
Page 9227 "Sales Analysis by Dim Matrix"
{
    ...
    procedure LoadVariables(ItemAnalysisView1: Record "Item Analysis View";CurrentItemAnalysisViewCode1: Code[10];CurrentAnalysisArea1: Option Sales,Purchase,Inventory;LineDimOption1: Option Item,Period,Location,"Dimension 1","Dimension 2","Dimension 3";ColumnDimOption1: Option Item,Period,Location,"Dimension 1","Dimension 2","Dimension 3";LineDimCode1: Text[30];ColumnDimCode1: Text[30];PeriodType1: Option Day,Week,Month,Quarter,Year,"Accounting Period";ValueType1: Option "Sales Amount","Inventory Value","Sales Quantity";RoundingFactor1: Option "None","1","1000","1000000";ShowActualBudget1: Option "Actual Amounts","Budgeted Amounts",Variance,"Variance%","Index%";MatrixColumnCaptions1: array [32] of Text[1024];ShowOppositeSign1: Boolean;PeriodInitialized1: Boolean;ShowColumnName1: Boolean;NoOfRecordsLocal: Integer)
    begin
