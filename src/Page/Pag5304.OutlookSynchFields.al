    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the number of the Outlook item property that will be synchronized with the Microsoft Dynamics NAV table field specified in the Field No. field.';
                }
