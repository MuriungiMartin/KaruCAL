    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the code linked to entries that are posted using the Calc. and Post Tax Settlement batch job.';
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the code linked to entries that are posted using the Date Compress Tax Entries batch job.';
                }
            ...
            group(Inventory)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the code linked to entries that are posted from an Item Reclass. Journal.';
                }
            ...
            group(Warehouse)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the code for the Whse. Reclassification Journal.';
                }
                field("Whse. Phys. Invt. Journal";"Whse. Phys. Invt. Journal")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the code for the Whse. Phys. Invt. Journal.';
                }
