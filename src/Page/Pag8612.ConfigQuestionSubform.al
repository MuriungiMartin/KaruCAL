        ...
        area(content)
        {
            repeater(Control1)
            {
                field("No.";"No.")
                {
                    ...
                    MinValue = 1;
                    ToolTip = 'Specifies a number for the question. For manually created questions, numbering starts from 0 unless you specify another starting point. Otherwise, numbering is sequential and starts from 1.';
                }
