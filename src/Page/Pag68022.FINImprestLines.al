    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Type of Surrender";"Type of Surrender")
                {
                    ApplicationArea = Basic;
                }
                field("Dept. Vch. No.";"Dept. Vch. No.")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("EFT Account Name";"EFT Account Name")
                {
                    ApplicationArea = Basic;
                }
