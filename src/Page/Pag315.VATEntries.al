        ...
        area(content)
        {
            repeater(Control1)
            {
                field("Entry No.";"Entry No.")
                {
                    ...
                    ToolTip = 'Specifies the number assigned to the entry.';
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the type of goods and services tax (GST) for the tax entry. You can select Acquisition, Self-Assessment, Rebate, New Housing Rebates, or Pension Rebate for the GST tax.';
                }
                field(Type;Type)
                {
                    ApplicationArea = Basic,Suite;
