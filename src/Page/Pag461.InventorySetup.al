        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Outbound Whse. Handling Time";"Outbound Whse. Handling Time")
                {
                    ApplicationArea = Basic;
                    Importance = Additional;
                    ToolTip = 'Specifies a date formula for the outbound warehouse handling time for your company in general.';
                }
                field("Inbound Whse. Handling Time";"Inbound Whse. Handling Time")
                {
                    ApplicationArea = Basic;
                    Importance = Additional;
                    ToolTip = 'Specifies a date formula for the inbound warehouse handling time for your company in general.';
                }
            ...
            group(Numbering)
            {
                ...
                field("Nonstock Item Nos.";"Nonstock Item Nos.")
                {
                    ...
                    Importance = Additional;
                    ToolTip = 'Specifies the number series that is used for nonstock items.';
                }
                ...
                field("Item Issue Template";"Item Issue Template")
                {
                    ApplicationArea = Basic;
                }
                field("Item Issue Batch";"Item Issue Batch")
                {
                    ApplicationArea = Basic;
                }
                field("Issue Location";"Issue Location")
                {
                    ApplicationArea = Basic;
                }
