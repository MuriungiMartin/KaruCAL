        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(CancelReservation)
                {
                    ...
                    Image = Cancel;
                    ToolTip = 'Cancel the reservation that exists for the selected job planning line.';
                ...
                action(ShowDocument)
                {
                    ...
                    ToolTip = 'Open the document that the job planning line is related to, such as a purchase order.';
