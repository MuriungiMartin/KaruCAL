    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the number of the job to which this WIP entry is related.';
                }
                ...
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the dimension value code that the job WIP entry is linked to. You cannot change the code because the entry has been posted.';
                }
                field("Global Dimension 2 Code";"Global Dimension 2 Code")
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the dimension value code that the job WIP task is linked to. You cannot change the code because the entry has been posted.';
                }
                field("Entry No.";"Entry No.")
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the number of the WIP entry.';
                }
            }
        }
        area(factboxes)
