...
Page 2103 "O365 Sales Document List"
{
    ...
    actions
    {
        area(processing)
        {
            action(ShowLatest)
            {
                ...
                Image = Document;
                ToolTip = 'Displays all invoices, sorted by their invoice date.';
            ...
            action(ShowDraft)
            {
                ...
                Image = DocumentEdit;
                ToolTip = 'Displays draft invoices.';
            ...
            action(DeleteDraftInvoice)
            {
                ...
                Image = Delete;
                Scope = Repeater;
                ToolTip = 'Deletes the draft invoice.';
    ...
    var
        ...
        DeletePostedInvoiceErr: label 'Only draft invoices can be deleted.';
}
