...
Report 5692 "Calculate Depreciation"
{
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "No.","FA Posting Group","FA Class Code","FA Subclass Code","Budgeted Asset";
    ...
    procedure InitializeRequest(DeprBookCodeFrom: Code[10];DeprUntilDateFrom: Date;UseForceNoOfDaysFrom: Boolean;DaysInPeriodFrom: Integer;PostingDateFrom: Date;DocumentNoFrom: Code[20];PostingDescriptionFrom: Text[250];BalAccountFrom: Boolean)
    begin
