...
Page 69173 "ACA-Std Rooms - Swap/Switch"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(CurrDetails2)
            {
                ...
                field("Switched to Hostel No";"Switched to Hostel No")
                {
                    ApplicationArea = Basic;
                    Caption = 'Swap With Hostel';
                }
                field("Switched to Room No";"Switched to Room No")
                {
                    ApplicationArea = Basic;
                    Caption = 'Swap With Room';
                }
                field("Switched to Space No";"Switched to Space No")
                {
                    ApplicationArea = Basic;
            ...
            group(Validation)
            {
                field("Reason for Switch";"Reason for Switch")
                {
                    ApplicationArea = Basic;
                }
                field("Reverse Allocated By";"Reverse Allocated By")
                {
                    ApplicationArea = Basic;
                }
            }
            ...
            action(switch_Rooms)
            {
                ...
                begin
                      // TESTFIELD(Cleared,true);
                       TestField("Switched to Hostel No");
                       TestField("Switched to Room No");
                       TestField("Switched to Space No");
                       TestField("Hostel No");
                       TestField("Room No");
                       TestField("Space No");
                      ...
                      StudentHostel2.SetRange(StudentHostel2."Hostel No","Switched to Hostel No");
                      StudentHostel2.SetRange(StudentHostel2."Room No","Switched to Room No");
                      StudentHostel2.SetRange(StudentHostel2."Space No","Switched to Space No");
                      StudentHostel2.SetRange(StudentHostel2.Semester,Semester);
                      StudentHostel2.SetRange(StudentHostel2.Cleared,false);
                       if StudentHostel2.Find('-') then OtherStudent:=StudentHostel2.Student;
                       OtherHostel:="Switched to Hostel No";
                       OtherRoom:="Switched to Room No";
                       OtherSpace:="Switched to Space No";


                        if (("Switched to Hostel No" = "Hostel No") and
                       ("Switched to Room No"="Room No") and ("Switched to Space No"="Space No")
                       ) then Error('The two rooms and Spaces are the same');
                    ...
                    if CourseReg.Find('-') then begin
                     ...
                     // Check if the room costs are equal
                       ...
                       rooms2.Reset;
                       rooms2.SetRange(rooms2."Hostel Code","Switched to Hostel No");
                       rooms2.SetRange(rooms2."Room Code","Switched to Room No");
                       ...
                       if CourseReg."Settlement Type"='JAB' then begin
                        ...
                        end else if CourseReg."Settlement Type"='SSP' then begin
                        if not (rooms1."SSP Fees"=rooms2."SSP Fees") then Error('Fees for the destination room must be equat to '+Format(rooms1."SSP Fees"));
                             ...
                             if Confirm('Swap student from '+"Space No"+' with student from '+"Switched to Space No",false)=false then Error('Switch cancelled');
                             // Get the student in the 2nd Room
                             if (("Switched to Room No"="Room No") and ("Switched to Space No"="Space No")) then Error('The students belong to the same room.');
                      ...
                      StudentHostel2.SetRange(StudentHostel2.Cleared,false);
                       if StudentHostel2.Find('-') then begin
                          ...
                          StudentHostel2."Switched to Hostel No":=CurrentHostel;
                          StudentHostel2."Switched to Room No":=CurrentRoom ;
                          StudentHostel2."Switched to Space No":=CurrentSpace;
                          StudentHostel2."Switched from Hostel No":=OtherHostel ;
                          StudentHostel2."Switched from Room No":=OtherRoom;
                          StudentHostel2."Switched from Space No":=OtherSpace;
                          StudentHostel2.Modify;
                       end else Error('No student in the second room.');
                             // Clear Existing Room
                              clearFromRoom();
                    ...
                    //  Creg1.SETRANGE(Creg1."Academic Year","Academic Year");
                      if Creg1.Find('-') then begin
                        ...
                        Book_Room_Swap(settlementType);
                        // Assign Items
                        hostcard.Reset;
                        hostcard.SetRange(hostcard."Asset No","Switched to Hostel No");
                        if hostcard.Find('-') then begin
                          invItems.Reset;
                          if hostcard.Gender=hostcard.Gender::Male then
                          invItems.SetFilter(invItems."Hostel Gender",'%1|%2',1,2);
                          if invItems.Find('-') then begin
                           ...
                           // studItemInv.SETRANGE(studItemInv."Academic Year","Academic Year");
                            ...
                            repeat
                              begin
                                studItemInv.Init;
                                studItemInv."Hostel Block":="Switched to Hostel No";
                                studItemInv."Room Code":="Switched to Room No";
                                studItemInv."Space Code":="Switched to Space No";
                                studItemInv."Item Code":=invItems.Item;
                                studItemInv."Academic Year":="Academic Year";
                                studItemInv.Semester:=Semester;
                                studItemInv.Quantity:=invItems."Quantity Per Room";
                    ...
                    //  Creg1.SETRANGE(Creg1."Academic Year","Academic Year");
                      if Creg1.Find('-') then begin
                        ...
                        Book_Room_2nd_RoomSwap(settlementType);
                        // Assign Items
                        hostcard.Reset;
    ...
    procedure Book_Room(var settle_m: Option " ",JAB,SSP,"Special Programme")
    var
        rooms: Record "ACA-Hostel Block Rooms";
        billAmount: Decimal;
        counted: Integer;
    begin
        ...
        StudentHostel.Student :=Student;
        StudentHostel."Space No":="Switched to Space No";
        StudentHostel."Room No":="Switched to Room No";
        StudentHostel."Hostel No":="Switched to Hostel No";
        ...
        StudentHostel.Allocated :=true;
        StudentHostel."Transfed from Hostel No":="Hostel No";
        StudentHostel."Transfed from Room No":="Room No";
        StudentHostel."Transfed from Space No":="Space No" ;
        StudentHostel.Gender:= Gender;
         StudentHostel.Insert(true);
        
          Clear(billAmount);
           rooms.Reset;
          rooms.SetRange(rooms."Hostel Code","Switched to Hostel No");
          rooms.SetRange(rooms."Room Code","Switched to Room No");
          if rooms.Find('-') then begin
        ...
        if coReg.Find('-') then begin
          ...
          if Host_Ledger.Find('-') then counts:=Host_Ledger.Count;
          Host_Ledger.Init;
            Host_Ledger."Space No":="Switched to Space No";
            Host_Ledger."Room No":="Switched to Room No";
            Host_Ledger."Hostel No":="Switched to Hostel No";
            Host_Ledger.No:=counts;
            Host_Ledger.Status:=Host_Ledger.Status::"Fully Occupied";
    ...
    begin
        ...
        // hostLedger.SETRANGE(hostLedger."Hostel No","Switched to Hostel No");
         hostLedger.SetRange(hostLedger."Room No",OtherRoom);
         hostLedger.SetRange(hostLedger."Space No",OtherSpace);

         if hostLedger.Find('-') then begin
         repeat
         begin
        HostRooms.Reset;
        HostRooms.SetRange(HostRooms.Student,OtherStudent);
        //HostRooms.SETRANGE(HostRooms."Academic Year",hostLedger."Academic Year");
        HostRooms.SetRange(HostRooms.Semester,hostLedger.Semester);
        HostRooms.SetRange(HostRooms."Hostel No",OtherHostel);
        HostRooms.SetRange(HostRooms."Room No",OtherRoom);
        HostRooms.SetRange(HostRooms."Space No",OtherSpace);
        HostRooms.SetFilter(HostRooms.Cleared,'=%1',false);
        if HostRooms.Find('-') then begin
          HostRooms.Cleared:=true;
          HostRooms."Clearance Date":=Today;
        ...
        spaces.Reset;
        spaces.SetRange(spaces."Hostel Code",OtherHostel);
        spaces.SetRange(spaces."Room Code",OtherRoom);
        spaces.SetRange(spaces."Space Code",OtherSpace);
        if spaces.Find('-') then begin
        repeat
        begin
        spaces.Status:=spaces.Status::Vaccant;
        ...
        until spaces.Next=0;
          ...
          Rooms.Reset;
         Rooms.SetRange(Rooms."Hostel Code",OtherHostel);
         Rooms.SetRange(Rooms."Room Code",OtherRoom);
         if Rooms.Find('-') then begin
          repeat
           Rooms.Validate(Rooms.Status);
          until Rooms.Next = 0;
    ...
    procedure Book_Room_2nd_Room(var settle_m: Option " ",JAB,SSP,"Special Programme")
    var
        rooms: Record "ACA-Hostel Block Rooms";
        billAmount: Decimal;
        counted: Integer;
    begin
        ...
        StudentHostel."Space No":="Space No";
        StudentHostel."Room No":="Room No";
        StudentHostel."Hostel No":="Hostel No";
        StudentHostel."Accomodation Fee":="Accomodation Fee";
        StudentHostel."Allocation Date":=Today;
        StudentHostel.Charges:= Charges;
        StudentHostel.Billed :=Billed;
        ...
        StudentHostel."Academic Year":="Academic Year";
        StudentHostel.Allocated :=true;
        StudentHostel."Switched from Hostel No":="Switched to Hostel No";
        StudentHostel."Switched from Room No":="Switched to Room No";
        StudentHostel."Switched from Space No":="Switched to Space No" ;
        StudentHostel."Switched to Hostel No":="Hostel No";
        StudentHostel."Switched to Room No":="Room No";
        StudentHostel."Switched to Space No":="Space No";
        StudentHostel.Gender:= Gender;
    ...
    procedure Book_Room_Swap(var settle_m: Option " ",JAB,SSP,"Special Programme")
    var
        rooms: Record "ACA-Hostel Block Rooms";
        billAmount: Decimal;
        counted: Integer;
    begin
        ...
        StudentHostel."Space No":=OtherSpace;
        StudentHostel."Room No":=OtherRoom;
        StudentHostel."Hostel No":=OtherHostel;
        StudentHostel."Accomodation Fee":="Accomodation Fee";
        StudentHostel."Allocation Date":=Today;
        StudentHostel.Charges:= Charges;
        StudentHostel.Billed :=Billed;
        ...
        StudentHostel."Academic Year":="Academic Year";
        StudentHostel.Allocated :=true;
        StudentHostel."Switched from Hostel No":=CurrentHostel;
        StudentHostel."Switched from Room No":=CurrentRoom;
        StudentHostel."Switched from Space No":=CurrentSpace ;
        StudentHostel.Gender:= Gender;
         StudentHostel.Insert(true);
        
            Rooms_Spaces.Reset;
            Rooms_Spaces.SetRange(Rooms_Spaces."Space Code",OtherSpace);
            Rooms_Spaces.SetRange(Rooms_Spaces."Room Code",OtherRoom);
            if Rooms_Spaces.Find('-') then begin
              Rooms_Spaces.Status:=Rooms_Spaces.Status::"Fully Occupied";
              Rooms_Spaces.Modify;
              end;
          ...
          if Host_Ledger.Find('-') then counts:=Host_Ledger.Count;
          Host_Ledger.Init;
            Host_Ledger."Space No":=OtherSpace;
            Host_Ledger."Room No":=OtherRoom;
            Host_Ledger."Hostel No":=OtherHostel;
            Host_Ledger.No:=counts;
            Host_Ledger.Status:=Host_Ledger.Status::"Fully Occupied";
            Host_Ledger."Room Cost":=Charges;
        ...
        Hostel_Rooms.Reset;
        Hostel_Rooms.SetRange(Hostel_Rooms."Hostel Code",OtherHostel);
        Hostel_Rooms.SetRange(Hostel_Rooms."Room Code",OtherRoom);
        ...
        //  END;
          Cust.RESET;
          Cust.SETRANGE(Cust."No.",CurrentStudent);
          IF Cust.FIND('-') THEN BEGIN
          END;
    ...
    procedure Book_Room_2nd_RoomSwap(var settle_m: Option " ",JAB,SSP,"Special Programme")
    var
        rooms: Record "ACA-Hostel Block Rooms";
        billAmount: Decimal;
        counted: Integer;
    begin
        ...
        StudentHostel.Init;
        StudentHostel."Line No":=counted;
        StudentHostel.Student :=OtherStudent;
        StudentHostel."Space No":=CurrentSpace;
        StudentHostel."Room No":=CurrentRoom;
        StudentHostel."Hostel No":=CurrentHostel;
        StudentHostel."Accomodation Fee":="Accomodation Fee";
        StudentHostel."Allocation Date":=Today;
        StudentHostel.Charges:= Charges;
        StudentHostel.Billed :=Billed;
        ...
        StudentHostel."Academic Year":="Academic Year";
        StudentHostel.Allocated :=true;
        StudentHostel."Switched from Hostel No":=OtherHostel;
        StudentHostel."Switched from Room No":=OtherRoom;
        StudentHostel."Switched from Space No":=OtherSpace ;
        StudentHostel.Gender:= Gender;
         StudentHostel.Insert(true);

            Rooms_Spaces.Reset;
            Rooms_Spaces.SetRange(Rooms_Spaces."Space Code",CurrentSpace);
            Rooms_Spaces.SetRange(Rooms_Spaces."Room Code",CurrentRoom);
            if Rooms_Spaces.Find('-') then begin
              Rooms_Spaces.Status:=Rooms_Spaces.Status::"Fully Occupied";
              Rooms_Spaces.Modify;
              end;
          ...
          if Host_Ledger.Find('-') then counts:=Host_Ledger.Count;
          Host_Ledger.Init;
            Host_Ledger."Space No":=CurrentSpace;
            Host_Ledger."Room No":=CurrentRoom;
            Host_Ledger."Hostel No":=CurrentHostel;
            Host_Ledger.No:=counts;
            Host_Ledger.Status:=Host_Ledger.Status::"Fully Occupied";
            Host_Ledger."Room Cost":=Charges;
            Host_Ledger."Student No":=OtherStudent;
            Host_Ledger."Receipt No":='';
            Host_Ledger.Semester:=Semester;
            Host_Ledger.Gender:= Gender;
            Host_Ledger."Hostel Name":='';
        ...
        Hostel_Rooms.Reset;
        Hostel_Rooms.SetRange(Hostel_Rooms."Hostel Code",CurrentHostel);
        Hostel_Rooms.SetRange(Hostel_Rooms."Room Code",CurrentRoom);
        if Hostel_Rooms.Find('-') then Hostel_Rooms.Validate(Status);
    end;
}
