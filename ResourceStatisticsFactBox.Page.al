...
{
    Caption = 'Resource Statistics - Year To Date';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            ...
            field(InvoicedPct;InvoicedPct)
            {
                ...
                Caption = 'Invoiced %';
                DecimalPlaces = 1:1;
                ToolTip = 'Specifies the percentage of invoiced amounts in unit prices. It is calculated as follows: Invoiced % = (Invoiced($) / Usage(UnitPrice)) x 100.';
            }
