            ...
            group(Reporting)
            {
                ...
                group("Use Add.-Curr Exch. Rate")
                {
                    ...
                    field("Add.-Curr. Exch. Rate - Depr.";"Add.-Curr. Exch. Rate - Depr.")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Depreciation';
                        ToolTip = 'Records depreciation transactions in the general ledger in both $ and any additional reporting currency.';
                    }
                    field("Add-Curr Exch Rate -Write-Down";"Add-Curr Exch Rate -Write-Down")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Write-Down';
                        ToolTip = 'Records write-down transactions in the general ledger in both $ and any additional reporting currency.';
                    }
                    field("Add-Curr. Exch. Rate - Apprec.";"Add-Curr. Exch. Rate - Apprec.")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Appreciation';
                        ToolTip = 'Records appreciation transactions in the general ledger in both $ and any additional reporting currency.';
                    }
                    ...
                    field("Add-Curr. Exch Rate - Custom 2";"Add-Curr. Exch Rate - Custom 2")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Custom 2';
                        ToolTip = 'Records custom 2 transactions in the general ledger in both $ and any additional reporting currency.';
                    }
                    field("Add.-Curr. Exch. Rate - Disp.";"Add.-Curr. Exch. Rate - Disp.")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Disposal';
                        ToolTip = 'Records disposal transactions in the general ledger in both $ and any additional reporting currency.';
                    }
                    field("Add.-Curr. Exch. Rate - Maint.";"Add.-Curr. Exch. Rate - Maint.")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Maintenance';
                        ToolTip = 'Records maintenance transactions in the general ledger in both $ and any additional reporting currency.';
                    }
                }
            }
        }
