    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the job number, if there is one, associated with an archived time sheet.';
                }
                field("Job Task No.";"Job Task No.")
                {
                    ApplicationArea = Jobs;
                    ToolTip = 'Specifies the associated job task number, if there is one, for an archived time sheet.';
                }
