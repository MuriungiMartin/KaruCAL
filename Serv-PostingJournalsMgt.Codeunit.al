...
Codeunit 5987 "Serv-Posting Journals Mgt."
{
    ...
    local procedure IsWarehouseShipment(): Boolean
    var
    ...
    procedure PostInvoicePostBufferLine(var InvoicePostBuffer: Record "Invoice Post. Buffer";DocType: Integer;DocNo: Code[20];ExtDocNo: Code[20];var TempSalesTaxAmtLine: Record UnknownRecord10011 temporary;TaxOption: Option ,VAT,SalesTax;SalesTaxCountry: Option US,CA,,,,,,,,,,,,NoTax;var TotalServiceLineLCY: Record "Service Line")
    var
    ...
    local procedure PostResJnlLine(ServiceHeader: Record "Service Header";ServiceLine: Record "Service Line";DocNo: Code[20];ExtDocNo: Code[35];SrcCode: Code[10];PostingNoSeries: Code[10];EntryType: Option;Qty: Decimal;UnitPrice: Decimal;TotalPrice: Decimal)
    var
        ResJnlLine: Record "Res. Journal Line";
    begin
    ...
    local procedure PostSalesTaxToGL(var TempSalesTaxAmtLine: Record UnknownRecord10011 temporary;var TotalServiceLineLCY: Record "Service Line";GenJnlLineDocType: Integer;GenJnlLineDocNo: Code[20];GenJnlLineExtDocNo: Code[20];SalesTaxCountry: Option US,CA,,,,,,,,,,,,NoTax)
    var
