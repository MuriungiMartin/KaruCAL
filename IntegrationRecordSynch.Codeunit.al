...
Codeunit 5336 "Integration Record Synch."
{
    ...
    local procedure TransferField(SourceFieldNo: Integer;DestinationFieldNo: Integer;ConstantValue: Text;ValidateDestinationField: Boolean): Boolean
    var
    ...
    local procedure TransferFieldData(var SourceFieldRef: FieldRef;var DestinationFieldRef: FieldRef;ValidateDestinationField: Boolean): Boolean
    var
        NewValue: Variant;
