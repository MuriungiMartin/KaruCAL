...
Report 78012 "Final Senate Classification"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Final Senate Classification.rdlc';

    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            DataItemTableView = sorting("Year of Admission","Student No.") order(ascending) where("Is Final Year Student"=filter(Yes),Reversed=filter(No),Status=filter(Registration|Current|Deceased),"Final Clasification"=filter(<>""),"Final Stage"=filter(Yes),"Yearly Total Units Taken"=filter(>0));
            ...
            begin
                ...
                //////////////////..........................................................................
                    ...
                    ACASenateReportCounts.SetRange("Student No.","ACA-Course Registration"."Student No.");
                    if not ACASenateReportCounts.Find('-') then CurrReport.Skip;
                ...
                if not ACASenateReportStatusBuff.Find('-') then begin
                    ...
                    ACASenateReportStatusBuff."User ID":=UserId;
                ...
                ACASenateReportStatusBuff.SetRange("Academic Year","ACA-Course Registration"."Graduation Academic Year");
                ACASenateReportStatusBuff.SetRange(YoS,"ACA-Course Registration"."Year Of Study");
                ACASenateReportStatusBuff.SetRange("Exists in Counts",true);
