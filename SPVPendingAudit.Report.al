...
Report 51221 "SPV Pending Audit"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SPV Pending Audit.rdlc';

    dataset
    {
        dataitem(UnknownTable61134;UnknownTable61134)
        {
            DataItemTableView = sorting(No) where(Status=const("1st Approval"),"Payment Type"=const(Salary),Posted=const(No),"Approved By"=const("<>"));
            ...
            column(SPVs_Pending_AuditCaption;SPVs_Pending_AuditCaptionLbl)
            {
            }
    ...
    var
        SPVs_Pending_AuditCaptionLbl: label 'SPVs Pending Audit';
