...
Page 77712 "Process Graduation Params2"
{
    PageType = Card;
        ...
        area(creation)
        {
            action(ProcessGraduation)
            {
                ...
                var
                    ...
                    ProgListsz: Record UnknownRecord61511;
                    Aca2ndSpecialExamsDetails: Record UnknownRecord78031;
                    ACAUnitsSubjects693: Record UnknownRecord61517;
                    AcaSpecialExamsResults333: Record UnknownRecord78003;
                    ...
                    ClassUnitsSubjects: Record UnknownRecord61517;
                ...
                begin
                    ...
                    ProgListsz.Reset;
                    if Schools <> '' then
                      ProgListsz.SetFilter("School Code",Schools)
                    else if programs<>'' then
                      ProgListsz.SetFilter(Code,programs);
                    if ProgListsz.Find('-') then begin
                      repeat
                        begin
                    ...
                    Clear(ACAProgramme963);
                      ...
                      ACAProgramme963.SetFilter(ACAProgramme963.Code,ProgListsz.Code);
                      if ACAProgramme963.Find('-') then begin
                        repeat
                          ...
                          until ProgListsz.Next = 0;
                          end;

                    Clear(Coregcs);
                    Coregcs.Reset;
                    Coregcs.SetFilter(Status,'=%1|=%2',Coregcs.Status::Registration,Coregcs.Status::Current);
                    ...
                    RemeiningRecs:=RemeiningRecs-1;
                        // Create Registration Unit entry if Not Exists
                         ...
                         Progressbar.Update(6,'----------------------------------------------------');
                          ...
                          ACAProgrammeYearsofStudy.SetRange("Programme Code",Coregcs.Programme);
                          if not ACAProgrammeYearsofStudy.Find('-') then Error('Academic Years Missing!');
                        Clear(ProgFIls);
                        ProgFIls:=Coregcs.Programme;
                    ...
                    ClassStudentUnits.SetFilter("Student No.",Coregcs."Student No.");
                    ClassStudentUnits.SetFilter(Programme,ProgFIls);
                    ClassStudentUnits.SetFilter("Exists Final Stage",'%1',true);
                    ClassStudentUnits.SetFilter(Semester,'=%1',Coregcs.Semester);
                    ...
                    ClassClassificationStudents.SetFilter("Student Number",Coregcs."Student No.");
                    ClassClassificationStudents.SetFilter(Programme,Coregcs.Programme);
                        ...
                        repeat
                          ...
                          if ACAProgrammeYearsofStudy.Find('-') then begin
                            repeat
                              ...
                              CourseRegistration666.SetRange("Exclude from Computation",false);
                    ...
                    if ACANotGraduatingReasons.Find('-') then ACANotGraduatingReasons.DeleteAll;
                         ...
                         if Progyz.Get(ClassClassificationStudents.Programme) then begin
                          ...
                          Clear(ClassClassificationUnits);
                            ClassClassificationUnits.Reset;
                    ...
                    ;
                                    ...
                                    Clear(ClassExamResults);
                                     ClassExamResults.Reset;
                                     ClassExamResults.SetRange("Student No.",ClassClassificationUnits."Student No.");
                                     ClassExamResults.SetRange(Unit,ClassClassificationUnits."Unit Code"); //ClassStudentUnits
