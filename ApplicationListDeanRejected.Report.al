...
Report 51356 "Application List Dean Rejected"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Dean Rejected.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const("Dean Rejected"));
