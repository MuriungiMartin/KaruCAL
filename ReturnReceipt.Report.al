...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Return Receipt.rdlc';
        ...
        dataitem("Return Receipt Header";"Return Receipt Header")
        {
            ...
            dataitem("Return Receipt Line";"Return Receipt Line")
            {
                ...
                dataitem(SalesLineComments;"Sales Comment Line")
                {
                    ...
                    DataItemTableView = sorting("Document Type","No.","Document Line No.","Line No.") where("Document Type"=const("Posted Return Receipt"),"Print On Return Receipt"=const(Yes));
            ...
            dataitem("Sales Comment Line";"Sales Comment Line")
            {
                ...
                DataItemTableView = sorting("Document Type","No.","Document Line No.","Line No.") where("Document Type"=const("Posted Return Receipt"),"Print On Return Receipt"=const(Yes),"Document Line No."=const(0));
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    {
                        DataItemTableView = sorting(Number);
                        column(ReportForNavId_6876; 6876)
                        {
                        }
