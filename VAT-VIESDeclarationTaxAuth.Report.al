...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/VAT- VIES Declaration Tax Auth.rdlc';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    {
                        ApplicationArea = Basic;
                        Caption = 'Tax. Registration No. Filter';
                    }
                }
            }
        }
    ...
    labels
    {
        ...
        Seller_s_VAT_Registration_No_Caption = 'Seller''s Tax Registration No.';
        NLCaption = 'NL';
        ...
        Customers_VAT_Registration_No_Caption = 'Customer Tax Registration No.';
    ...
    var
        ...
        Text001: label 'The Tax Registration No. is not filled in for all tax entries where for Customer %1 on one or more entries.';
