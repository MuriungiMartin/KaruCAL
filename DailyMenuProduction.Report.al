...
Report 51237 "Daily Menu Production"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Daily Menu Production.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61169;UnknownTable61169)
        {
            ...
            column(Daily_Menu__Total_Qty_;"Total Qty")
            {
            }
            column(Daily_Menu__Unit_Cost_;"Unit Cost")
            {
            }
            column(Daily_Menu__Total_Cost_;"Total Cost")
            {
            }
            column(Daily_Menu_Type;Type)
            {
            }
            ...
            column(Availlable_QtyCaption;Availlable_QtyCaptionLbl)
            {
            }
            column(Daily_Menu__Unit_Cost_Caption;FieldCaption("Unit Cost"))
            {
            }
            column(Daily_Menu__Total_Cost_Caption;FieldCaption("Total Cost"))
            {
            }
            column(Daily_Menu_TypeCaption;FieldCaption(Type))
            {
            }
    ...
    var
        ...
        Availlable_QtyCaptionLbl: label 'Availlable Qty';
}
