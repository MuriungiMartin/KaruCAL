        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Processing Report ID";"Processing Report ID")
                {
                    ApplicationArea = Basic,Suite;
                    BlankZero = true;
                    ToolTip = 'Specifies the codeunit that has been set up to process data before you apply it to a Microsoft Dynamics NAV database. By default, Microsoft Dynamics NAV uses codeunit 8621.';
                    Visible = false;
                }
                ...
                {
                    ApplicationArea = Basic,Suite;
                    ToolTip = 'Specifies the ID of the page that is associated with the migration table. You can choose an ID from the list in the Objects window.';
                }
