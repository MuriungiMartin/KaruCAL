...
Page 65000 "Cash Sale Header-Staff"
{
    Caption = 'Staff Cash Sales';
    DeleteAllowed = false;
    ModifyAllowed = true;
    PageType = Document;
    ...
    begin
        ...
        "Due Date":=Today;
        "Location Code":='MSTF';//FINCashOfficeUserTemplate."Default Direct Sales Location";
        "Document Date":=Today;
        "External Document No.":=NoSeriesMgt.GetNextNo(FINCashOfficeUserTemplate."Direct Sales External Doc. Nos",Today,true);
        "Sales Location Category":="sales location category"::Staff;
        "Created By":=UserId;
