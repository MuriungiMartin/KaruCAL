        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Bal. Account Type";"Bal. Account Type")
                {
                    ApplicationArea = Basic,Suite;
                    Editable = false;
                    ToolTip = 'Specifies the code for the balancing account type that will be used with this reversal.';
                }
                field("Bal. Account No.";"Bal. Account No.")
                {
                    ApplicationArea = Basic,Suite;
                    Editable = false;
                    ToolTip = 'Specifies the number for the balancing account that will be used with this reversal.';
                }
                field(Amount;Amount)
                {
                    ApplicationArea = Basic;
