...
Codeunit 905 "Assembly Line Management"
{
    ...
    local procedure AddBOMLine2(AsmHeader: Record "Assembly Header";var AssemblyLine: Record "Assembly Line";AsmLineRecordIsTemporary: Boolean;BomComponent: Record "BOM Component";ShowDueDateBeforeWorkDateMessage: Boolean)
    var
