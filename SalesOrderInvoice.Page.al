        ...
        area(content)
        {
            ...
            group(Invoicing)
            {
                ...
                field("Bill-to County";"Bill-to County")
                {
                    ...
                    ToolTip = 'Specifies the state, ZIP code, province code, state code, or postal code as a part of the address.';
                }
                field("Bill-to Post Code";"Bill-to Post Code")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the ZIP Code of the of the customer that the invoice is sent to.';
                }
