...
Report 78098 "FLT-Maintenance Per Vehicle"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/FLT-Maintenance Per Vehicle.rdlc';

    dataset
    {
        dataitem(MaintHeader;UnknownTable55517)
        {
            RequestFilterFields = "Req. Date","Service Done By (Employee)","Vehicle Registration";
            ...
            column(sname;MaintHeader."Supplier Name")
            {
            }
