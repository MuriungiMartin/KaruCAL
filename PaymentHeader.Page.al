...
Page 50669 "Payment Header"
{
    ...
    SourceTableView = where(Posted=const(No),"Payment Type"=const(Normal),Status=filter(<>Cancelled));
    ...
    layout
    {
        area(content)
        {
            group(Control1)
            {
                ...
                field("Total VAT Withholding Amount";"Total VAT Withholding Amount")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Bank Criteria";"Bank Criteria")
                {
                    ApplicationArea = Basic;
                }
            ...
            group("&Functions")
            {
                ...
                action(Bank_Letter)
                {
                    ...
                    begin
                        ...
                        //REPORT.RUN(60007,TRUE,TRUE,FilterbyPayline);
                        RESET;*/
