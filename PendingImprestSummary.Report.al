...
Report 51251 "Pending  Imprest Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Pending  Imprest Summary.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61134;UnknownTable61134)
        {
            ...
            RequestFilterFields = Date,"Pay Mode","Account No.";
            ...
            column(Pending_Imprest_SummaryCaption;Pending_Imprest_SummaryCaptionLbl)
            {
            }
            ...
            column(Payments_Amount_Control1000000018Caption;FieldCaption(Amount))
            {
            }
            ...
            begin
                   ...
                   "FIN-Payments".SetRange(Surrendered,false);
            end;
        }
    }
    ...
    var
        ...
        Pending_Imprest_SummaryCaptionLbl: label 'Pending Imprest Summary';
