...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Consolidated Marksheet Detaile.rdlc';

    dataset
    {
        dataitem(UnknownTable61532;UnknownTable61532)
        {
            DataItemTableView = sorting("Student No.") order(ascending) where("Units Taken"=filter(>0),"Cust Exist"=filter(>0),Blocked=const(0),"Register for"=const(Stage),Reversed=filter(No));
            ...
            column(Course_Registration___Student_No___FORMAT__Course_Registration___Marks_Status__;"ACA-Course Registration"."Student No."+Format("ACA-Course Registration"."Registered Reason"))
            {
            }
            ...
            begin
                ...
                */
                ...
                if Sem.Get("ACA-Course Registration".Semester) then
                if Sem."BackLog Marks"=false then
                CCat:='c';
                "ACA-Course Registration"."Exam Status":='SUPP';
                end;
                if StudUnits."CAT Total Marks"=0 then begin
                CCat:='e';
                "ACA-Course Registration"."Exam Status":='DSTC';
                end;
                end;
                end;
                //END;
                ...
                if CCat='' then
                if GetGradeStatus(UnitsR."Total Score","ACA-Course Registration".Programme,UnitsR.Code) =true then  begin
                CCat:='^';
                "ACA-Course Registration"."Exam Status":='SUPP';
                end;
                //UnitsR.SETRANGE(Code,"ACA-Course Registration".Programme);
                //UnitsR.SETRANGE("Semester Filter","ACA-Course Registration"."Semester Filter");
                //UnitsR.SETRANGE("Stage Code","ACA-Course Registration".Stage);
                ...
                //"ACA-Course Registration".CALCFIELDS("ACA-Course Registration"."Year Of Study");
                ...
                */
                ...
                "ACA-Course Registration".CalcFields("ACA-Course Registration"."CF Count") ;
                ColumnV[i]:=Format("ACA-Course Registration"."CF Count");
                
                i:=i+1;
                ColumnH[i]:='Weighted Total';
                "ACA-Course Registration".CalcFields("ACA-Course Registration"."CF Total Score") ;
                ColumnV[i]:=Format("ACA-Course Registration"."CF Total Score");
                
                i:=i+1;
                ColumnH[i]:='Units Passed';
                //IF UTaken > 0 THEN
                ColumnV[i]:=Format("ACA-Course Registration"."Year Of Study");
                //AvScore[i]:=AvScore[i]+"Course Registration"."Cum Units Passed";
                
                
                i:=i+1;
                ColumnH[i]:='Units Failed';
                //"ACA-Course Registration".CALCFIELDS("ACA-Course Registration"."Yearly Grade") ;
                ColumnV[i]:=Format("ACA-Course Registration"."Yearly Grade");
                //AvScore[i]:=AvScore[i]+"Course Registration"."Cum Units Failed";
                
                i:=i+1;
                //"ACA-Course Registration".CALCFIELDS("ACA-Course Registration"."Cum Units Special") ;
                ColumnH[i]:='Units Special';
                ColumnV[i]:=Format("ACA-Course Registration"."Total Yearly Marks");
                ...
                ColumnH[i]:='CF% Failed';
                if ("ACA-Course Registration"."Cum Units Passed"<>0) and ("ACA-Course Registration"."Cum Units Done"<>0) then begin
                //ColumnV[i]:=FORMAT(ROUND((("ACA-Course Registration"."Cum Units Done"-("ACA-Course Registration"."Cum Units Passed"+"ACA-Course Registration"."Cum Units Special"))/
                //"ACA-Course Registration"."Cum Units Done")*100,0.01,'='));
                //ColumnV[i]:=FORMAT(ROUND(("ACA-Course Registration"."Yearly Grade")/("ACA-Course Registration"."CF Count")*100,0.01,'='));
                
                decAverage:=ROUND((("ACA-Course Registration"."Cum Units Done"-("ACA-Course Registration"."Cum Units Passed"+"ACA-Course Registration"."Total Yearly Marks"))/
                "ACA-Course Registration"."Cum Units Done")*100,0.01,'=');
                
                if "ACA-Course Registration"."Cum Units Done"<>0 then
                if (("ACA-Course Registration"."Cum Units Done"-"ACA-Course Registration"."Cum Units Passed")/"ACA-Course Registration"."Cum Units Done")*100>25.01 then
                "ACA-Course Registration"."Exam Status":='REPEAT';
                
                if "ACA-Course Registration"."Cum Units Done"<>0 then
                if (("ACA-Course Registration"."Cum Units Done"-"ACA-Course Registration"."Cum Units Passed")/"ACA-Course Registration"."Cum Units Done")*100>50.01 then
                "ACA-Course Registration"."Exam Status":='Discontinue';
                
                if "ACA-Course Registration"."Cum Units Done"<>0 then
                if ("ACA-Course Registration"."CF Count"="ACA-Course Registration"."Year Of Study") then //AND ("ACA-Course Registration"."Cum Units Done">0) THEN
                ...
                if ("ACA-Course Registration"."Cum Average" > 0) and ("ACA-Course Registration"."Cum Units Done">0) then begin
                ColumnV[i]:=Format(ROUND("ACA-Course Registration"."Cum Average"/"ACA-Course Registration"."Cum Units Done",0.01,'>'));
                //AvScore[i]:=AvScore[i]+ROUND("Course Registration"."Cum Average"/"Course Registration"."Cum Units Done",0.01,'>');
                "ACA-Course Registration"."Cumm Score":=ROUND("ACA-Course Registration"."Cum Average"/"ACA-Course Registration"."Cum Units Done",0.01,'>');
                ...
                */
                ...
                if ("ACA-Course Registration"."Cum Units Failed">0) and ("ACA-Course Registration"."Total Yearly Marks">0) then
                "ACA-Course Registration"."Exam Status":='SUPPSPECIAL';
                
                if DTSCExist=false then begin
                
                //IF (decAverage >= 25.01) AND (decAverage <= 50) THEN "ACA-Course Registration"."Exam Status":='PASS' ELSE
                ...
                if "ACA-Course Registration"."Cum Units Done"<>0 then
                if (("ACA-Course Registration"."Cum Units Done"-"ACA-Course Registration"."Cum Units Passed")/"ACA-Course Registration"."Cum Units Done")*100<25.0 then
                "ACA-Course Registration"."Exam Status":='SUPP';
                if "ACA-Course Registration"."Cum Units Done"<>0 then
                if (("ACA-Course Registration"."Cum Units Done"-"ACA-Course Registration"."Cum Units Passed")/"ACA-Course Registration"."Cum Units Done")*100>25.01 then
                "ACA-Course Registration"."Exam Status":='REPEAT';
                ...
                if DTSCExist=true then   "ACA-Course Registration"."Exam Status":='DTSC';
                //--------------ENd Denno
                ...
                MaxStage:="ACA-Course Registration".GetRangemax("ACA-Course Registration"."Stage Filter");
                "ACA-Course Registration".SetFilter("ACA-Course Registration"."Cummulative Year Filter",'%1..%2','',MaxStage);
                "ACA-Course Registration".CalcFields("ACA-Course Registration"."CF Count");
                "ACA-Course Registration".CalcFields("ACA-Course Registration"."Total CF Count");
                if ("ACA-Course Registration"."CF Count" > 0) and ("ACA-Course Registration"."Total CF Count">0) then begin
                ColumnV[i]:=Format(ROUND("ACA-Course Registration"."Total CF Count"/"ACA-Course Registration"."Total CF Count",0.01,'>'));
                //AvScore[i]:=AvScore[i]+ROUND("Course Registration"."Cum Average"/"Course Registration"."Cum Units Done",0.01,'>');
                ...
                ResultStatus.SetFilter(ResultStatus."Programme Filter","ACA-Course Registration".GetFilter("ACA-Course Registration"."Programme Filter"));
                ResultStatus.SetFilter(ResultStatus."Stage Filter","ACA-Course Registration".GetFilter("ACA-Course Registration"."Stage Filter"));
                ResultStatus.SetFilter(ResultStatus.Semester,"ACA-Course Registration".GetFilter("ACA-Course Registration".Semester));
                ResultStatus.SetFilter(ResultStatus."Session Filter","ACA-Course Registration".GetFilter("ACA-Course Registration".Session));
                ...
                until ResultStatus.Next=0;
                  ...
                  j:=2;
                   ...
                   StudUnits.SetFilter(StudUnits.Programme,"ACA-Course Registration".GetFilter("Programme Filter"));
                   StudUnits.SetFilter(StudUnits.Stage,"ACA-Course Registration".GetFilter("ACA-Course Registration"."Stage Filter"));
                   StudUnits.SetFilter(StudUnits.Semester,"ACA-Course Registration".GetFilter("ACA-Course Registration"."Semester Filter"));
                  ...
                  // ColumnVA[i]:=FORMAT((TReg));
                   ...
                   STD[i]:=Power((STD[i]/"ACA-Course Registration".Count),0.5);
                ...
                CReg.Ascending:=true;
                CReg.SetRange(CReg.Programme,"ACA-Course Registration".Programme);
                CReg.SetFilter(CReg.Stage,"ACA-Course Registration".GetFilter("ACA-Course Registration"."Stage Filter"));
                CReg.SetFilter(CReg.Semester,"ACA-Course Registration".GetFilter("ACA-Course Registration"."Semester Filter"));
                //IF CReg.FIND('-') THEN
            ...
            begin
                ...
                Sem.Reset;
                Sem.SetFilter(Sem.Code,"ACA-Course Registration".GetFilter(Semester)) ;
                if Sem.Find('-') then
                ...
                //"ACA-Course Registration".SETFILTER("ACA-Course Registration".Semester,GETFILTER("ACA-Course Registration"."Semester Filter"));
                ...
                OptionsComb.SetRange(OptionsComb."Programme Code",CReg.Programme);
    ...
    var
        ...
        DontCont: Boolean;
        CAve: Decimal;
        Intake: Record UnknownRecord61383;
        ShowCount: Integer;
        ...
        YearDesc: Code[20];
        CFTotal: Decimal;
        OptionsComb: Record UnknownRecord61554;
        strExamRMK: Text;
        decAverage: Decimal;
        DTSCExist: Boolean;
        MaxStage: Code[20];
