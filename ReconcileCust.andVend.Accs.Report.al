...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Reconcile Cust. and Vend. Accs.rdlc';
    ...
    local procedure CalcCustAccAmount(PostingGr: Code[10]): Decimal
    var
    ...
    local procedure CalcCustCreditAmount(PostingGr: Code[10];EntryType: Option): Decimal
    var
        Cust: Record Customer;
        DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry";
    ...
    local procedure CalcCustDebitAmount(PostingGr: Code[10];EntryType: Option): Decimal
    var
        Cust: Record Customer;
        DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry";
    ...
    local procedure CalcVendAccAmount(PostingGr: Code[10]): Decimal
    var
        Vend: Record Vendor;
        DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry";
    ...
    local procedure CalcVendCreditAmount(PostingGr: Code[10];EntryType: Option): Decimal
    var
        Vend: Record Vendor;
        DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry";
    ...
    local procedure CalcVendDebitAmount(PostingGr: Code[10];EntryType: Option): Decimal
    var
        Vend: Record Vendor;
        DtldVendLedgEntry: Record "Detailed Vendor Ledg. Entry";
    ...
    local procedure CalcCurrGainLossAmount(CurrencyCode: Code[10];EntryType: Option): Decimal
    var
        Cust: Record Customer;
        DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry";
        Vend: Record Vendor;
