...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Official journal ledger Summ..rdlc';
    ...
    dataset
    {
        dataitem("Integer";"Integer")
        {
            ...
            column(CurrReport_PAGENO___Pagina_Control25;CurrReport.PageNo + Pagina)
            {
            }
            column(FORMAT_TODAY_0_4__Control26;Format(Today,0,4))
            {
            }
            column(COMPANYNAME_Control27;COMPANYNAME)
            {
            }
            ...
            dataitem(Cuenta2;"G/L Account")
            {
                ...
                column(ReportForNavId_6941; 6941)
                {
                }
                column(j;j)
                {
