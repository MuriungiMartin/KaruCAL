...
Codeunit 5774 "Whse.-Production Release"
{
    ...
    procedure Release(ProdHeader: Record "Production Order")
    var
    ...
    local procedure CreateWhseRqst(var ProdOrderComp: Record "Prod. Order Component";var ProdHeader: Record "Production Order")
    var
