...
Codeunit 60114 "HR Dates2"
{
    ...
    var
        ...
        s: Integer;
        WeekendDays: Integer;
        AbsencePreferences: Record UnknownRecord39005717;
        Holidays: Integer;
    begin
    ...
    var
        AbsenceHoliday: Record UnknownRecord39005646;
        OK: Boolean;
    begin
    ...
    var
        StatutoryHoliday: Record UnknownRecord39005718;
        NextDay: Date;
    begin
                  Holiday:= 0;
                  while (DateStart <= DateEnd) do begin
