...
Codeunit 900 "Assembly-Post"
{
    ...
    begin
        ...
        if PostingDateExists and (ReplacePostingDate or ("Posting Date" = 0D)) then
    ...
    local procedure PostItemConsumption(AssemblyHeader: Record "Assembly Header";var AssemblyLine: Record "Assembly Line";PostingNoSeries: Code[10];QtyToConsume: Decimal;QtyToConsumeBase: Decimal;var ItemJnlPostLine: Codeunit "Item Jnl.-Post Line";var WhseJnlRegisterLine: Codeunit "Whse. Jnl.-Register Line";DocumentNo: Code[20];IsCorrection: Boolean;ApplyToEntryNo: Integer): Integer
    var
    ...
    local procedure PostItemOutput(var AssemblyHeader: Record "Assembly Header";PostingNoSeries: Code[10];QtyToOutput: Decimal;QtyToOutputBase: Decimal;var ItemJnlPostLine: Codeunit "Item Jnl.-Post Line";var WhseJnlRegisterLine: Codeunit "Whse. Jnl.-Register Line";DocumentNo: Code[20];IsCorrection: Boolean;ApplyToEntryNo: Integer): Integer
    var
        ItemJnlLine: Record "Item Journal Line";
    ...
    local procedure PostCorrectionItemJnLine(var ItemJnlLine: Record "Item Journal Line";AssemblyHeader: Record "Assembly Header";var ItemJnlPostLine: Codeunit "Item Jnl.-Post Line";SourceType: Integer;ApplyToEntry: Integer)
    var
    ...
    local procedure PostResourceConsumption(AssemblyHeader: Record "Assembly Header";var AssemblyLine: Record "Assembly Line";PostingNoSeries: Code[10];QtyToConsume: Decimal;QtyToConsumeBase: Decimal;var ResJnlPostLine: Codeunit "Res. Jnl.-Post Line";var ItemJnlPostLine: Codeunit "Item Jnl.-Post Line";DocumentNo: Code[20];IsCorrection: Boolean)
    var
        ItemJnlLine: Record "Item Journal Line";
