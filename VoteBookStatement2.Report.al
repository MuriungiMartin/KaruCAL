...
Report 77739 "Vote Book Statement 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Vote Book Statement 2.rdlc';

    dataset
    {
        dataitem(UnknownTable61722;UnknownTable61722)
        {
            RequestFilterFields = "Posting Date",Budget;
            ...
            column(G_L_Account__No__;"FIN-Committment"."G/L Account No.")
            {
            }
            column(G_L_Account_Name;"FIN-Committment".Description)
            {
            }
            column(Allocation;"FIN-Committment"."Month Budget")
            {
            }
            ...
            column(GlobalDimension2Code_GLAccount;"FIN-Committment"."Shortcut Dimension 1 Code")
            {
            }
                ...
                // Get Allocations
                   ...
                   Exp:=0;
                    ...
                    GLaccount.CalcFields(GLaccount."Net Change");
                     Allocation:=GLaccount."Budgeted Amount";
                     Exp:=Abs(GLaccount."Net Change");
                 // Get Transfers

                    Transfer:=0;
                    BudgetEntry.Reset;
                    BudgetEntry.SetFilter(BudgetEntry."G/L Account No.",GLaccount."No.");
                    ...
                    if FilterUser then
                      ...
                      BudgetEntry.SetFilter(BudgetEntry."Budget Dimension 1 Code",GLaccount.GetFilter(
                      GLaccount."Global Dimension 2 Filter"));
                  ...
                  Commitment:=0;
                  CommRec.Reset;
                  CommRec.SetFilter(CommRec."G/L Account No.",GLaccount."No.");
                  //CommRec.SETRANGE(CommRec.Closed,FALSE);
                 // IF FilterUser THEN
                   //CommRec.SETFILTER(CommRec.Department,UserDept)
                 // ELSE
                  CommRec.SetFilter(CommRec."Shortcut Dimension 1 Code",GLaccount.GetFilter(GLaccount."Global Dimension 2 Filter"));
