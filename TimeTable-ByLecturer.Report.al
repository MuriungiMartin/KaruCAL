...
Report 51533 "Time Table - By Lecturer"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Time Table - By Lecturer.rdlc';
    ...
    dataset
    {
        dataitem(UnknownTable61514;UnknownTable61514)
        {
            ...
            column(GETFILTER__Lecturer_Filter__;GetFilter("Lecturer Filter"))
            {
            }
            ...
            column(Lecture_Caption;Lecture_CaptionLbl)
            {
            }
            ...
            begin
                ...
                T[Lessons."No."] :=T[Lessons."No."] + '[' + TimeTable.Programme + ' ' + TimeTable.Stage + ' '
                 + TimeTable.Unit + ' ' + TimeTable."Lecture Room" + ']';
            ...
            begin
                Name:='';
                if Emp.Get("ACA-Day Of Week".GetFilter("ACA-Day Of Week"."Lecturer Filter")) then
    ...
    var
        ...
        Lecture_CaptionLbl: label 'Lecture:';
