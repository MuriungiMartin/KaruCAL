...
Report 51376 "Application List Dept Pending"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Application List Dept Pending.rdlc';

    dataset
    {
        dataitem(UnknownTable61358;UnknownTable61358)
        {
            DataItemTableView = sorting("Application No.") where(Status=const("Pending Approval"));
